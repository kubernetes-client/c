...
CoordinationV1API_createNamespacedLease(apiClient_t *apiClient, char *_namespace, v1_lease_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases");
    ...
    v1_lease_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1_lease_parseFromJSON(CoordinationV1APIlocalVarJSON);
...
//
v1_status_t*
CoordinationV1API_deleteCollectionNamespacedLease(apiClient_t *apiClient, char *_namespace, char *pretty, char *_continue, char *dryRun, char *fieldSelector, int *gracePeriodSeconds, int *ignoreStoreReadErrorWithClusterBreakingPotential, char *labelSelector, int *limit, int *orphanDependents, char *propagationPolicy, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, v1_delete_options_t *body)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1_status_parseFromJSON(CoordinationV1APIlocalVarJSON);
        cJSON_Delete(CoordinationV1APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
//
v1_status_t*
CoordinationV1API_deleteNamespacedLease(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *ignoreStoreReadErrorWithClusterBreakingPotential, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}");
...
CoordinationV1API_getAPIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1/");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1_api_resource_list_parseFromJSON(CoordinationV1APIlocalVarJSON);
        cJSON_Delete(CoordinationV1APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
CoordinationV1API_listLeaseForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1/leases");
    ...
    //}
    //nonprimitive not container
    v1_lease_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1_lease_list_parseFromJSON(CoordinationV1APIlocalVarJSON);
        cJSON_Delete(CoordinationV1APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
