...
#include <stdio.h>
#include <ctype.h>
#include "FlowcontrolApiserverV1beta2API.h"
...
FlowcontrolApiserverV1beta2API_createFlowSchema(apiClient_t *apiClient, v1beta2_flow_schema_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta2_flow_schema_convertToJSON(body);
    ...
    cJSON *FlowcontrolApiserverV1beta2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta2_flow_schema_t *elementToReturn = v1beta2_flow_schema_parseFromJSON(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1beta2APIlocalVarJSON);
...
FlowcontrolApiserverV1beta2API_createPriorityLevelConfiguration(apiClient_t *apiClient, v1beta2_priority_level_configuration_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta2_priority_level_configuration_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1beta2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta2_priority_level_configuration_t *elementToReturn = v1beta2_priority_level_configuration_parseFromJSON(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1beta2API_deleteCollectionFlowSchema(apiClient_t *apiClient, char *pretty, char *_continue, char *dryRun, char *fieldSelector, int *gracePeriodSeconds, char *labelSelector, int *limit, int *orphanDependents, char *propagationPolicy, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, v1_delete_options_t *body)
{
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1beta2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1_status_t*
FlowcontrolApiserverV1beta2API_deleteFlowSchema(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}");
...
//
v1_status_t*
FlowcontrolApiserverV1beta2API_deletePriorityLevelConfiguration(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}");
...
FlowcontrolApiserverV1beta2API_getAPIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/");
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1beta2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1beta2API_listFlowSchema(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1beta2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta2_flow_schema_list_t *elementToReturn = v1beta2_flow_schema_list_parseFromJSON(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
FlowcontrolApiserverV1beta2API_listPriorityLevelConfiguration(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *FlowcontrolApiserverV1beta2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta2_priority_level_configuration_list_t *elementToReturn = v1beta2_priority_level_configuration_list_parseFromJSON(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    cJSON_Delete(FlowcontrolApiserverV1beta2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1beta2_flow_schema_t*
FlowcontrolApiserverV1beta2API_patchFlowSchema(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_flow_schema_t*
FlowcontrolApiserverV1beta2API_patchFlowSchemaStatus(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}/status");
...
//
v1beta2_priority_level_configuration_t*
FlowcontrolApiserverV1beta2API_patchPriorityLevelConfiguration(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_priority_level_configuration_t*
FlowcontrolApiserverV1beta2API_patchPriorityLevelConfigurationStatus(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}/status");
...
//
v1beta2_flow_schema_t*
FlowcontrolApiserverV1beta2API_readFlowSchema(apiClient_t *apiClient, char *name, char *pretty)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_flow_schema_t*
FlowcontrolApiserverV1beta2API_readFlowSchemaStatus(apiClient_t *apiClient, char *name, char *pretty)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_priority_level_configuration_t*
FlowcontrolApiserverV1beta2API_readPriorityLevelConfiguration(apiClient_t *apiClient, char *name, char *pretty)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_priority_level_configuration_t*
FlowcontrolApiserverV1beta2API_readPriorityLevelConfigurationStatus(apiClient_t *apiClient, char *name, char *pretty)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_flow_schema_t*
FlowcontrolApiserverV1beta2API_replaceFlowSchema(apiClient_t *apiClient, char *name, v1beta2_flow_schema_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_flow_schema_t*
FlowcontrolApiserverV1beta2API_replaceFlowSchemaStatus(apiClient_t *apiClient, char *name, v1beta2_flow_schema_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_priority_level_configuration_t*
FlowcontrolApiserverV1beta2API_replacePriorityLevelConfiguration(apiClient_t *apiClient, char *name, v1beta2_priority_level_configuration_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta2_priority_level_configuration_t*
FlowcontrolApiserverV1beta2API_replacePriorityLevelConfigurationStatus(apiClient_t *apiClient, char *name, v1beta2_priority_level_configuration_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
