...
ResourceV1alpha3API_createDeviceTaintRule(apiClient_t *apiClient, v1alpha3_device_taint_rule_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/resource.k8s.io/v1alpha3/devicetaintrules");
    ...
    if (body != NULL)
    {
        ...
        localVarSingleItemJSON_body = v1alpha3_device_taint_rule_convertToJSON(body);
    ...
    v1alpha3_device_taint_rule_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ResourceV1alpha3APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1alpha3_device_taint_rule_parseFromJSON(ResourceV1alpha3APIlocalVarJSON);
...
ResourceV1alpha3API_deleteDeviceTaintRule(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *ignoreStoreReadErrorWithClusterBreakingPotential, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/resource.k8s.io/v1alpha3/devicetaintrules/{name}");
...
ResourceV1alpha3API_listDeviceTaintRule(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //}
    //nonprimitive not container
    v1alpha3_device_taint_rule_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ResourceV1alpha3APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1alpha3_device_taint_rule_list_parseFromJSON(ResourceV1alpha3APIlocalVarJSON);
        cJSON_Delete(ResourceV1alpha3APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
