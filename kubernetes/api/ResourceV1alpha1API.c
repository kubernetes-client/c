...
ResourceV1alpha1API_createNamespacedPodScheduling(apiClient_t *apiClient, char * _namespace , v1alpha1_pod_scheduling_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_pod_scheduling_convertToJSON(body);
    ...
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_pod_scheduling_t *elementToReturn = v1alpha1_pod_scheduling_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
...
ResourceV1alpha1API_createNamespacedResourceClaim(apiClient_t *apiClient, char * _namespace , v1alpha1_resource_claim_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_resource_claim_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_resource_claim_t *elementToReturn = v1alpha1_resource_claim_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_createNamespacedResourceClaimTemplate(apiClient_t *apiClient, char * _namespace , v1alpha1_resource_claim_template_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_resource_claim_template_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_resource_claim_template_t *elementToReturn = v1alpha1_resource_claim_template_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_createResourceClass(apiClient_t *apiClient, v1alpha1_resource_class_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/resourceclasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/resourceclasses");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_resource_class_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_resource_class_t *elementToReturn = v1alpha1_resource_class_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_deleteCollectionNamespacedPodScheduling(apiClient_t *apiClient, char * _namespace , char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , v1_delete_options_t * body )
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_deleteNamespacedPodScheduling(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}");
...
ResourceV1alpha1API_deleteNamespacedResourceClaim(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}");
...
ResourceV1alpha1API_deleteNamespacedResourceClaimTemplate(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}");
...
ResourceV1alpha1API_deleteResourceClass(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/resourceclasses/{name}");
...
ResourceV1alpha1API_getAPIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/");
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_listNamespacedPodScheduling(apiClient_t *apiClient, char * _namespace , char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_pod_scheduling_list_t *elementToReturn = v1alpha1_pod_scheduling_list_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_listNamespacedResourceClaim(apiClient_t *apiClient, char * _namespace , char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_resource_claim_list_t *elementToReturn = v1alpha1_resource_claim_list_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_listNamespacedResourceClaimTemplate(apiClient_t *apiClient, char * _namespace , char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_resource_claim_template_list_t *elementToReturn = v1alpha1_resource_claim_template_list_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_listPodSchedulingForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/podschedulings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/podschedulings");
...
ResourceV1alpha1API_listResourceClaimForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/resourceclaims")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/resourceclaims");
...
ResourceV1alpha1API_listResourceClaimTemplateForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/resourceclaimtemplates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/resourceclaimtemplates");
...
ResourceV1alpha1API_listResourceClass(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_resource_class_list_t *elementToReturn = v1alpha1_resource_class_list_parseFromJSON(ResourceV1alpha1APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha1API_patchNamespacedPodSchedulingStatus(apiClient_t *apiClient, char * name , char * _namespace , object_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation , int force )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}/status");
...
ResourceV1alpha1API_patchNamespacedResourceClaimStatus(apiClient_t *apiClient, char * name , char * _namespace , object_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation , int force )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status");
