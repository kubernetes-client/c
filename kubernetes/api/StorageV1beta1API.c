...
StorageV1beta1API_createNamespacedCSIStorageCapacity(apiClient_t *apiClient, char * _namespace , v1beta1_csi_storage_capacity_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_csi_storage_capacity_convertToJSON(body);
    ...
    v1beta1_csi_storage_capacity_t *elementToReturn = v1beta1_csi_storage_capacity_parseFromJSON(StorageV1beta1APIlocalVarJSON);
...
StorageV1beta1API_deleteNamespacedCSIStorageCapacity(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}");
...
StorageV1beta1API_listCSIStorageCapacityForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storage.k8s.io/v1beta1/csistoragecapacities")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storage.k8s.io/v1beta1/csistoragecapacities");
    ...
    //nonprimitive not container
    cJSON *StorageV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_csi_storage_capacity_list_t *elementToReturn = v1beta1_csi_storage_capacity_list_parseFromJSON(StorageV1beta1APIlocalVarJSON);
    cJSON_Delete(StorageV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
