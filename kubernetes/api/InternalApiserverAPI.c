...
//
v1_api_group_t*
InternalApiserverAPI_getAPIGroup(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/internal.apiserver.k8s.io/");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        ...
        elementToReturn = v1_api_group_parseFromJSON(InternalApiserverAPIlocalVarJSON);
