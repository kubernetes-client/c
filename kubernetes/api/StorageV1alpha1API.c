...
StorageV1alpha1API_createNamespacedCSIStorageCapacity(apiClient_t *apiClient, char * _namespace , v1alpha1_csi_storage_capacity_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_csi_storage_capacity_convertToJSON(body);
    ...
    v1alpha1_csi_storage_capacity_t *elementToReturn = v1alpha1_csi_storage_capacity_parseFromJSON(StorageV1alpha1APIlocalVarJSON);
...
StorageV1alpha1API_listCSIStorageCapacityForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    //nonprimitive not container
    cJSON *StorageV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_csi_storage_capacity_list_t *elementToReturn = v1alpha1_csi_storage_capacity_list_parseFromJSON(StorageV1alpha1APIlocalVarJSON);
    cJSON_Delete(StorageV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1alpha1_csi_storage_capacity_t*
StorageV1alpha1API_patchNamespacedCSIStorageCapacity(apiClient_t *apiClient, char * name , char * _namespace , object_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation , int force )
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1alpha1_csi_storage_capacity_t*
StorageV1alpha1API_replaceNamespacedCSIStorageCapacity(apiClient_t *apiClient, char * name , char * _namespace , v1alpha1_csi_storage_capacity_t * body , char * pretty , char * dryRun , char * fieldManager , char * fieldValidation )
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
