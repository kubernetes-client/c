...
NetworkingV1alpha1API_createIPAddress(apiClient_t *apiClient, v1alpha1_ip_address_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1alpha1/ipaddresses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1alpha1/ipaddresses");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_ip_address_convertToJSON(body);
    ...
    v1alpha1_ip_address_t *elementToReturn = v1alpha1_ip_address_parseFromJSON(NetworkingV1alpha1APIlocalVarJSON);
...
NetworkingV1alpha1API_createServiceCIDR(apiClient_t *apiClient, v1alpha1_service_cidr_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1alpha1/servicecidrs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1alpha1/servicecidrs");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_service_cidr_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *NetworkingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_service_cidr_t *elementToReturn = v1alpha1_service_cidr_parseFromJSON(NetworkingV1alpha1APIlocalVarJSON);
    cJSON_Delete(NetworkingV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NetworkingV1alpha1API_deleteIPAddress(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1alpha1/ipaddresses/{name}");
...
NetworkingV1alpha1API_deleteServiceCIDR(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}");
...
NetworkingV1alpha1API_listIPAddress(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *NetworkingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_ip_address_list_t *elementToReturn = v1alpha1_ip_address_list_parseFromJSON(NetworkingV1alpha1APIlocalVarJSON);
    cJSON_Delete(NetworkingV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NetworkingV1alpha1API_listServiceCIDR(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *NetworkingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_service_cidr_list_t *elementToReturn = v1alpha1_service_cidr_list_parseFromJSON(NetworkingV1alpha1APIlocalVarJSON);
    cJSON_Delete(NetworkingV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NetworkingV1alpha1API_patchServiceCIDRStatus(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1alpha1/servicecidrs/{name}/status");
