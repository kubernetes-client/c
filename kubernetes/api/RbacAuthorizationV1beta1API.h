...
//
v1beta1_role_t*
RbacAuthorizationV1beta1API_createNamespacedRole(apiClient_t *apiClient, char * _namespace , v1beta1_role_t * body , char * pretty , char * dryRun , char * fieldManager );


// create a RoleBinding
//
v1beta1_role_binding_t*
RbacAuthorizationV1beta1API_createNamespacedRoleBinding(apiClient_t *apiClient, char * _namespace , v1beta1_role_binding_t * body , char * pretty , char * dryRun , char * fieldManager );
...
//
v1_status_t*
RbacAuthorizationV1beta1API_deleteCollectionClusterRole(apiClient_t *apiClient, char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , int timeoutSeconds , v1_delete_options_t * body );
...
//
v1_status_t*
RbacAuthorizationV1beta1API_deleteCollectionNamespacedRoleBinding(apiClient_t *apiClient, char * _namespace , char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , int timeoutSeconds , v1_delete_options_t * body );


// delete a Role
//
v1_status_t*
RbacAuthorizationV1beta1API_deleteNamespacedRole(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body );


// delete a RoleBinding
//
v1_status_t*
RbacAuthorizationV1beta1API_deleteNamespacedRoleBinding(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , v1_delete_options_t * body );
...
//
v1beta1_role_list_t*
RbacAuthorizationV1beta1API_listNamespacedRole(apiClient_t *apiClient, char * _namespace , char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , int timeoutSeconds , int watch );


// list or watch objects of kind RoleBinding
//
v1beta1_role_binding_list_t*
RbacAuthorizationV1beta1API_listNamespacedRoleBinding(apiClient_t *apiClient, char * _namespace , char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , int timeoutSeconds , int watch );
...
//
v1beta1_role_t*
RbacAuthorizationV1beta1API_patchNamespacedRole(apiClient_t *apiClient, char * name , char * _namespace , object_t * body , char * pretty , char * dryRun , char * fieldManager , int force );


// partially update the specified RoleBinding
//
v1beta1_role_binding_t*
RbacAuthorizationV1beta1API_patchNamespacedRoleBinding(apiClient_t *apiClient, char * name , char * _namespace , object_t * body , char * pretty , char * dryRun , char * fieldManager , int force );
...
//
v1beta1_role_t*
RbacAuthorizationV1beta1API_readNamespacedRole(apiClient_t *apiClient, char * name , char * _namespace , char * pretty );


// read the specified RoleBinding
//
v1beta1_role_binding_t*
RbacAuthorizationV1beta1API_readNamespacedRoleBinding(apiClient_t *apiClient, char * name , char * _namespace , char * pretty );
...
//
v1beta1_role_t*
RbacAuthorizationV1beta1API_replaceNamespacedRole(apiClient_t *apiClient, char * name , char * _namespace , v1beta1_role_t * body , char * pretty , char * dryRun , char * fieldManager );


// replace the specified RoleBinding
//
v1beta1_role_binding_t*
RbacAuthorizationV1beta1API_replaceNamespacedRoleBinding(apiClient_t *apiClient, char * name , char * _namespace , v1beta1_role_binding_t * body , char * pretty , char * dryRun , char * fieldManager );
