...
#include "CoordinationV1alpha2API.h"
...
CoordinationV1alpha2API_createNamespacedLeaseCandidate(apiClient_t *apiClient, char *_namespace, v1alpha2_lease_candidate_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1alpha2/namespaces/{namespace}/leasecandidates");
    ...
    if (body != NULL)
    {
        ...
        localVarSingleItemJSON_body = v1alpha2_lease_candidate_convertToJSON(body);
    ...
    v1alpha2_lease_candidate_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1alpha2_lease_candidate_parseFromJSON(CoordinationV1alpha2APIlocalVarJSON);
        cJSON_Delete(CoordinationV1alpha2APIlocalVarJSON);
...
CoordinationV1alpha2API_deleteCollectionNamespacedLeaseCandidate(apiClient_t *apiClient, char *_namespace, char *pretty, char *_continue, char *dryRun, char *fieldSelector, int *gracePeriodSeconds, int *ignoreStoreReadErrorWithClusterBreakingPotential, char *labelSelector, int *limit, int *orphanDependents, char *propagationPolicy, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, v1_delete_options_t *body)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1_status_parseFromJSON(CoordinationV1alpha2APIlocalVarJSON);
        cJSON_Delete(CoordinationV1alpha2APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
//
v1_status_t*
CoordinationV1alpha2API_deleteNamespacedLeaseCandidate(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *ignoreStoreReadErrorWithClusterBreakingPotential, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1alpha2/namespaces/{namespace}/leasecandidates/{name}");
...
CoordinationV1alpha2API_getAPIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1alpha2/");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1_api_resource_list_parseFromJSON(CoordinationV1alpha2APIlocalVarJSON);
        cJSON_Delete(CoordinationV1alpha2APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
CoordinationV1alpha2API_listLeaseCandidateForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/apis/coordination.k8s.io/v1alpha2/leasecandidates");
    ...
    //}
    //nonprimitive not container
    v1alpha2_lease_candidate_list_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *CoordinationV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = v1alpha2_lease_candidate_list_parseFromJSON(CoordinationV1alpha2APIlocalVarJSON);
        cJSON_Delete(CoordinationV1alpha2APIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
//
v1alpha2_lease_candidate_list_t*
CoordinationV1alpha2API_listNamespacedLeaseCandidate(apiClient_t *apiClient, char *_namespace, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1alpha2_lease_candidate_t*
CoordinationV1alpha2API_patchNamespacedLeaseCandidate(apiClient_t *apiClient, char *name, char *_namespace, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1alpha2_lease_candidate_t*
CoordinationV1alpha2API_readNamespacedLeaseCandidate(apiClient_t *apiClient, char *name, char *_namespace, char *pretty)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1alpha2_lease_candidate_t*
CoordinationV1alpha2API_replaceNamespacedLeaseCandidate(apiClient_t *apiClient, char *name, char *_namespace, v1alpha2_lease_candidate_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    list_t    *localVarQueryParameters = list_createList();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
