...
ResourceV1alpha2API_createNamespacedPodSchedulingContext(apiClient_t *apiClient, char *_namespace, v1alpha2_pod_scheduling_context_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_pod_scheduling_context_convertToJSON(body);
    ...
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_pod_scheduling_context_t *elementToReturn = v1alpha2_pod_scheduling_context_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
...
ResourceV1alpha2API_createNamespacedResourceClaim(apiClient_t *apiClient, char *_namespace, v1alpha2_resource_claim_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_resource_claim_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_claim_t *elementToReturn = v1alpha2_resource_claim_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_createNamespacedResourceClaimParameters(apiClient_t *apiClient, char *_namespace, v1alpha2_resource_claim_parameters_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_resource_claim_parameters_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_claim_parameters_t *elementToReturn = v1alpha2_resource_claim_parameters_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_createNamespacedResourceClaimTemplate(apiClient_t *apiClient, char *_namespace, v1alpha2_resource_claim_template_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_resource_claim_template_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_claim_template_t *elementToReturn = v1alpha2_resource_claim_template_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_createNamespacedResourceClassParameters(apiClient_t *apiClient, char *_namespace, v1alpha2_resource_class_parameters_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_resource_class_parameters_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_class_parameters_t *elementToReturn = v1alpha2_resource_class_parameters_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_createResourceClass(apiClient_t *apiClient, v1alpha2_resource_class_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceclasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceclasses");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_resource_class_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_class_t *elementToReturn = v1alpha2_resource_class_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_createResourceSlice(apiClient_t *apiClient, v1alpha2_resource_slice_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceslices");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha2_resource_slice_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_slice_t *elementToReturn = v1alpha2_resource_slice_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_deleteCollectionNamespacedPodSchedulingContext(apiClient_t *apiClient, char *_namespace, char *pretty, char *_continue, char *dryRun, char *fieldSelector, int *gracePeriodSeconds, char *labelSelector, int *limit, int *orphanDependents, char *propagationPolicy, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, v1_delete_options_t *body)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_deleteNamespacedPodSchedulingContext(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}");
...
ResourceV1alpha2API_deleteNamespacedResourceClaim(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}");
...
ResourceV1alpha2API_deleteNamespacedResourceClaimParameters(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimparameters/{name}");
...
ResourceV1alpha2API_deleteNamespacedResourceClaimTemplate(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaimtemplates/{name}");
...
ResourceV1alpha2API_deleteNamespacedResourceClassParameters(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclassparameters/{name}");
...
ResourceV1alpha2API_deleteResourceClass(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceclasses/{name}");
...
ResourceV1alpha2API_deleteResourceSlice(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceslices/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceslices/{name}");
...
ResourceV1alpha2API_getAPIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/");
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listNamespacedPodSchedulingContext(apiClient_t *apiClient, char *_namespace, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_pod_scheduling_context_list_t *elementToReturn = v1alpha2_pod_scheduling_context_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listNamespacedResourceClaim(apiClient_t *apiClient, char *_namespace, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_claim_list_t *elementToReturn = v1alpha2_resource_claim_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listNamespacedResourceClaimParameters(apiClient_t *apiClient, char *_namespace, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_claim_parameters_list_t *elementToReturn = v1alpha2_resource_claim_parameters_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listNamespacedResourceClaimTemplate(apiClient_t *apiClient, char *_namespace, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_claim_template_list_t *elementToReturn = v1alpha2_resource_claim_template_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listNamespacedResourceClassParameters(apiClient_t *apiClient, char *_namespace, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_class_parameters_list_t *elementToReturn = v1alpha2_resource_class_parameters_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listPodSchedulingContextForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/podschedulingcontexts")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/podschedulingcontexts");
...
ResourceV1alpha2API_listResourceClaimForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceclaims")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceclaims");
...
ResourceV1alpha2API_listResourceClaimParametersForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceclaimparameters")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceclaimparameters");
...
ResourceV1alpha2API_listResourceClaimTemplateForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceclaimtemplates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceclaimtemplates");
...
ResourceV1alpha2API_listResourceClass(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_class_list_t *elementToReturn = v1alpha2_resource_class_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_listResourceClassParametersForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/resourceclassparameters")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/resourceclassparameters");
...
ResourceV1alpha2API_listResourceSlice(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    cJSON *ResourceV1alpha2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha2_resource_slice_list_t *elementToReturn = v1alpha2_resource_slice_list_parseFromJSON(ResourceV1alpha2APIlocalVarJSON);
    cJSON_Delete(ResourceV1alpha2APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ResourceV1alpha2API_patchNamespacedPodSchedulingContextStatus(apiClient_t *apiClient, char *name, char *_namespace, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/podschedulingcontexts/{name}/status");
...
ResourceV1alpha2API_patchNamespacedResourceClaimStatus(apiClient_t *apiClient, char *name, char *_namespace, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/resource.k8s.io/v1alpha2/namespaces/{namespace}/resourceclaims/{name}/status");
