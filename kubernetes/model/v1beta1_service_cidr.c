...
static v1beta1_service_cidr_t *v1beta1_service_cidr_create_internal(
    char *api_version,
    char *kind,
    ...
    v1beta1_service_cidr_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1beta1_service_cidr_t *v1beta1_service_cidr_create(
    ...
    return v1beta1_service_cidr_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1beta1_service_cidr_free(v1beta1_service_cidr_t *v1beta1_service_cidr) {
    ...
    if(v1beta1_service_cidr->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_service_cidr_free");
        return ;
    }
...
v1beta1_service_cidr_t *v1beta1_service_cidr_parseFromJSON(cJSON *v1beta1_service_cidrJSON){
    ...
    v1beta1_service_cidr_local_var = v1beta1_service_cidr_create_internal (
