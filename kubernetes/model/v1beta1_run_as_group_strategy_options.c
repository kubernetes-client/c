...
v1beta1_run_as_group_strategy_options_t *v1beta1_run_as_group_strategy_options_create(
    ...
    v1beta1_run_as_group_strategy_options_t *v1beta1_run_as_group_strategy_options_local_var = malloc(sizeof(v1beta1_run_as_group_strategy_options_t));
    if (!v1beta1_run_as_group_strategy_options_local_var) {
        return NULL;
    }
    v1beta1_run_as_group_strategy_options_local_var->ranges = ranges;
    v1beta1_run_as_group_strategy_options_local_var->rule = rule;

    return v1beta1_run_as_group_strategy_options_local_var;
}
...
void v1beta1_run_as_group_strategy_options_free(v1beta1_run_as_group_strategy_options_t *v1beta1_run_as_group_strategy_options) {
    if(NULL == v1beta1_run_as_group_strategy_options){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta1_run_as_group_strategy_options->ranges) {
        list_ForEach(listEntry, v1beta1_run_as_group_strategy_options->ranges) {
            v1beta1_id_range_free(listEntry->data);
        }
        list_freeList(v1beta1_run_as_group_strategy_options->ranges);
        v1beta1_run_as_group_strategy_options->ranges = NULL;
    }
    if (v1beta1_run_as_group_strategy_options->rule) {
        free(v1beta1_run_as_group_strategy_options->rule);
        v1beta1_run_as_group_strategy_options->rule = NULL;
    }
    free(v1beta1_run_as_group_strategy_options);
}
...
cJSON *v1beta1_run_as_group_strategy_options_convertToJSON(v1beta1_run_as_group_strategy_options_t *v1beta1_run_as_group_strategy_options) {
    ...
    if (v1beta1_run_as_group_strategy_options->ranges) {
    list_ForEach(rangesListEntry, v1beta1_run_as_group_strategy_options->ranges) {
...
v1beta1_run_as_group_strategy_options_t *v1beta1_run_as_group_strategy_options_parseFromJSON(cJSON *v1beta1_run_as_group_strategy_optionsJSON){
    ...
    v1beta1_run_as_group_strategy_options_t *v1beta1_run_as_group_strategy_options_local_var = NULL;

    // define the local list for v1beta1_run_as_group_strategy_options->ranges
    list_t *rangesList = NULL;

    // v1beta1_run_as_group_strategy_options->ranges
    cJSON *ranges = cJSON_GetObjectItemCaseSensitive(v1beta1_run_as_group_strategy_optionsJSON, "ranges");
    if (ranges) { 
    ...
    // v1beta1_run_as_group_strategy_options->rule
    cJSON *rule = cJSON_GetObjectItemCaseSensitive(v1beta1_run_as_group_strategy_optionsJSON, "rule");
    if (!rule) {
        goto end;
    }
    ...
    v1beta1_run_as_group_strategy_options_local_var = v1beta1_run_as_group_strategy_options_create (
