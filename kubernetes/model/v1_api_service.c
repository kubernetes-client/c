...
static v1_api_service_t *v1_api_service_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_api_service_local_var->_library_owned = 1;
    return v1_api_service_local_var;
}

__attribute__((deprecated)) v1_api_service_t *v1_api_service_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_api_service_spec_t *spec,
    ...
    return v1_api_service_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_api_service_free(v1_api_service_t *v1_api_service) {
    ...
    if(v1_api_service->_library_owned != 1){
...
v1_api_service_t *v1_api_service_parseFromJSON(cJSON *v1_api_serviceJSON){
    ...
    v1_api_service_local_var = v1_api_service_create_internal (
