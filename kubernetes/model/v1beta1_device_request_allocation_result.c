...
static v1beta1_device_request_allocation_result_t *v1beta1_device_request_allocation_result_create_internal(
    ...
    v1beta1_device_request_allocation_result_local_var->binding_conditions = binding_conditions;
    v1beta1_device_request_allocation_result_local_var->binding_failure_conditions = binding_failure_conditions;
    v1beta1_device_request_allocation_result_local_var->consumed_capacity = consumed_capacity;
    ...
    v1beta1_device_request_allocation_result_local_var->share_id = share_id;
    v1beta1_device_request_allocation_result_local_var->tolerations = tolerations;
...
void v1beta1_device_request_allocation_result_free(v1beta1_device_request_allocation_result_t *v1beta1_device_request_allocation_result) {
    ...
    if (v1beta1_device_request_allocation_result->binding_conditions) {
        list_ForEach(listEntry, v1beta1_device_request_allocation_result->binding_conditions) {
            free(listEntry->data);
        }
        list_freeList(v1beta1_device_request_allocation_result->binding_conditions);
        v1beta1_device_request_allocation_result->binding_conditions = NULL;
    }
    if (v1beta1_device_request_allocation_result->binding_failure_conditions) {
        list_ForEach(listEntry, v1beta1_device_request_allocation_result->binding_failure_conditions) {
            free(listEntry->data);
        }
        list_freeList(v1beta1_device_request_allocation_result->binding_failure_conditions);
        v1beta1_device_request_allocation_result->binding_failure_conditions = NULL;
    }
    if (v1beta1_device_request_allocation_result->consumed_capacity) {
        list_ForEach(listEntry, v1beta1_device_request_allocation_result->consumed_capacity) {
            keyValuePair_t *localKeyValue = listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_freeList(v1beta1_device_request_allocation_result->consumed_capacity);
        v1beta1_device_request_allocation_result->consumed_capacity = NULL;
    }
    ...
    if (v1beta1_device_request_allocation_result->share_id) {
        free(v1beta1_device_request_allocation_result->share_id);
        v1beta1_device_request_allocation_result->share_id = NULL;
    }
    if (v1beta1_device_request_allocation_result->tolerations) {
        list_ForEach(listEntry, v1beta1_device_request_allocation_result->tolerations) {
            v1beta1_device_toleration_free(listEntry->data);
        }
        list_freeList(v1beta1_device_request_allocation_result->tolerations);
        v1beta1_device_request_allocation_result->tolerations = NULL;
    }
...
cJSON *v1beta1_device_request_allocation_result_convertToJSON(v1beta1_device_request_allocation_result_t *v1beta1_device_request_allocation_result) {
    ...
    // v1beta1_device_request_allocation_result->binding_conditions
    if(v1beta1_device_request_allocation_result->binding_conditions) {
    ...
    list_ForEach(binding_conditionsListEntry, v1beta1_device_request_allocation_result->binding_conditions) {
    ...
    // v1beta1_device_request_allocation_result->binding_failure_conditions
    if(v1beta1_device_request_allocation_result->binding_failure_conditions) {
    ...
    list_ForEach(binding_failure_conditionsListEntry, v1beta1_device_request_allocation_result->binding_failure_conditions) {
    ...
    // v1beta1_device_request_allocation_result->consumed_capacity
    if(v1beta1_device_request_allocation_result->consumed_capacity) {
    ...
    if (v1beta1_device_request_allocation_result->consumed_capacity) {
    list_ForEach(consumed_capacityListEntry, v1beta1_device_request_allocation_result->consumed_capacity) {
    ...
    // v1beta1_device_request_allocation_result->share_id
    if(v1beta1_device_request_allocation_result->share_id) {
    if(cJSON_AddStringToObject(item, "shareID", v1beta1_device_request_allocation_result->share_id) == NULL) {
    goto fail; //String
    }
    }


    // v1beta1_device_request_allocation_result->tolerations
    if(v1beta1_device_request_allocation_result->tolerations) {
    ...
    if (v1beta1_device_request_allocation_result->tolerations) {
    list_ForEach(tolerationsListEntry, v1beta1_device_request_allocation_result->tolerations) {
...
v1beta1_device_request_allocation_result_t *v1beta1_device_request_allocation_result_parseFromJSON(cJSON *v1beta1_device_request_allocation_resultJSON){
    ...
    // define the local list for v1beta1_device_request_allocation_result->binding_conditions
    list_t *binding_conditionsList = NULL;

    // define the local list for v1beta1_device_request_allocation_result->binding_failure_conditions
    list_t *binding_failure_conditionsList = NULL;

    // define the local map for v1beta1_device_request_allocation_result->consumed_capacity
    list_t *consumed_capacityList = NULL;

    // define the local list for v1beta1_device_request_allocation_result->tolerations
    ...
    // v1beta1_device_request_allocation_result->binding_conditions
    cJSON *binding_conditions = cJSON_GetObjectItemCaseSensitive(v1beta1_device_request_allocation_resultJSON, "bindingConditions");
    ...
    // v1beta1_device_request_allocation_result->binding_failure_conditions
    cJSON *binding_failure_conditions = cJSON_GetObjectItemCaseSensitive(v1beta1_device_request_allocation_resultJSON, "bindingFailureConditions");
    ...
    // v1beta1_device_request_allocation_result->consumed_capacity
    cJSON *consumed_capacity = cJSON_GetObjectItemCaseSensitive(v1beta1_device_request_allocation_resultJSON, "consumedCapacity");
    ...
    // v1beta1_device_request_allocation_result->share_id
    cJSON *share_id = cJSON_GetObjectItemCaseSensitive(v1beta1_device_request_allocation_resultJSON, "shareID");
    ...
    // v1beta1_device_request_allocation_result->tolerations
    cJSON *tolerations = cJSON_GetObjectItemCaseSensitive(v1beta1_device_request_allocation_resultJSON, "tolerations");
