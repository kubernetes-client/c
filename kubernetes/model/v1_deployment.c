...
static v1_deployment_t *v1_deployment_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_deployment_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_deployment_t *v1_deployment_create(
    ...
    return v1_deployment_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_deployment_free(v1_deployment_t *v1_deployment) {
    ...
    if(v1_deployment->_library_owned != 1){
...
v1_deployment_t *v1_deployment_parseFromJSON(cJSON *v1_deploymentJSON){
    ...
    v1_deployment_local_var = v1_deployment_create_internal (
