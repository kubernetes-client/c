/*
 * v1alpha1_service_cidr.h
 *
 * ServiceCIDR defines a range of IP addresses using CIDR format (e.g. 192.168.0.0/24 or 2001:db2::/64). This range is used to allocate ClusterIPs to Service objects.
 */

#ifndef _v1alpha1_service_cidr_H_
#define _v1alpha1_service_cidr_H_
...
typedef struct v1alpha1_service_cidr_t v1alpha1_service_cidr_t;
...
typedef struct v1alpha1_service_cidr_t {
    char *api_version; // string
    char *kind; // string
    struct v1_object_meta_t *metadata; //model
    struct v1alpha1_service_cidr_spec_t *spec; //model
    struct v1alpha1_service_cidr_status_t *status; //model
...
#endif /* _v1alpha1_service_cidr_H_ */
