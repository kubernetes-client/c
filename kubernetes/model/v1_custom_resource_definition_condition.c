...
static v1_custom_resource_definition_condition_t *v1_custom_resource_definition_condition_create_internal(
    ...
    v1_custom_resource_definition_condition_local_var->_library_owned = 1;
    return v1_custom_resource_definition_condition_local_var;
}

__attribute__((deprecated)) v1_custom_resource_definition_condition_t *v1_custom_resource_definition_condition_create(
    char *last_transition_time,
    char *message,
    char *reason,
    char *status,
    ...
    return v1_custom_resource_definition_condition_create_internal (
...
void v1_custom_resource_definition_condition_free(v1_custom_resource_definition_condition_t *v1_custom_resource_definition_condition) {
    ...
    if(v1_custom_resource_definition_condition->_library_owned != 1){
...
v1_custom_resource_definition_condition_t *v1_custom_resource_definition_condition_parseFromJSON(cJSON *v1_custom_resource_definition_conditionJSON){
    ...
    v1_custom_resource_definition_condition_local_var = v1_custom_resource_definition_condition_create_internal (
