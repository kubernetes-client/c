...
void v1alpha1_policy_rule_free(v1alpha1_policy_rule_t *v1alpha1_policy_rule) {
    ...
    if (v1alpha1_policy_rule->api_groups) {
        ...
        list_freeList(v1alpha1_policy_rule->api_groups);
    ...
    if (v1alpha1_policy_rule->non_resource_urls) {
        ...
        list_freeList(v1alpha1_policy_rule->non_resource_urls);
    ...
    if (v1alpha1_policy_rule->resource_names) {
        ...
        list_freeList(v1alpha1_policy_rule->resource_names);
        v1alpha1_policy_rule->resource_names = NULL;
    }
    if (v1alpha1_policy_rule->resources) {
        list_ForEach(listEntry, v1alpha1_policy_rule->resources) {
            free(listEntry->data);
        }
        list_freeList(v1alpha1_policy_rule->resources);
        v1alpha1_policy_rule->resources = NULL;
    }
    if (v1alpha1_policy_rule->verbs) {
        list_ForEach(listEntry, v1alpha1_policy_rule->verbs) {
            free(listEntry->data);
        }
        list_freeList(v1alpha1_policy_rule->verbs);
        v1alpha1_policy_rule->verbs = NULL;
    }
