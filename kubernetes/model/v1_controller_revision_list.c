...
static v1_controller_revision_list_t *v1_controller_revision_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1_controller_revision_list_local_var->_library_owned = 1;
    return v1_controller_revision_list_local_var;
}

__attribute__((deprecated)) v1_controller_revision_list_t *v1_controller_revision_list_create(
    char *api_version,
    list_t *items,
    char *kind,
    v1_list_meta_t *metadata
    ) {
    return v1_controller_revision_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1_controller_revision_list_free(v1_controller_revision_list_t *v1_controller_revision_list) {
    ...
    if(v1_controller_revision_list->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_controller_revision_list_free");
        return ;
    }
...
v1_controller_revision_list_t *v1_controller_revision_list_parseFromJSON(cJSON *v1_controller_revision_listJSON){
    ...
    v1_controller_revision_list_local_var = v1_controller_revision_list_create_internal (
