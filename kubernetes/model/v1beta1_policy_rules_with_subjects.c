...
v1beta1_policy_rules_with_subjects_t *v1beta1_policy_rules_with_subjects_create(
    ...
    v1beta1_policy_rules_with_subjects_t *v1beta1_policy_rules_with_subjects_local_var = malloc(sizeof(v1beta1_policy_rules_with_subjects_t));
    if (!v1beta1_policy_rules_with_subjects_local_var) {
        return NULL;
    }
    v1beta1_policy_rules_with_subjects_local_var->non_resource_rules = non_resource_rules;
    v1beta1_policy_rules_with_subjects_local_var->resource_rules = resource_rules;
    v1beta1_policy_rules_with_subjects_local_var->subjects = subjects;
...
void v1beta1_policy_rules_with_subjects_free(v1beta1_policy_rules_with_subjects_t *v1beta1_policy_rules_with_subjects) {
    if(NULL == v1beta1_policy_rules_with_subjects){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta1_policy_rules_with_subjects->non_resource_rules) {
...
cJSON *v1beta1_policy_rules_with_subjects_convertToJSON(v1beta1_policy_rules_with_subjects_t *v1beta1_policy_rules_with_subjects) {
    ...
    if (v1beta1_policy_rules_with_subjects->non_resource_rules) {
    list_ForEach(non_resource_rulesListEntry, v1beta1_policy_rules_with_subjects->non_resource_rules) {
    cJSON *itemLocal = v1beta1_non_resource_policy_rule_convertToJSON(non_resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if (v1beta1_policy_rules_with_subjects->resource_rules) {
    list_ForEach(resource_rulesListEntry, v1beta1_policy_rules_with_subjects->resource_rules) {
    cJSON *itemLocal = v1beta1_resource_policy_rule_convertToJSON(resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    // v1beta1_policy_rules_with_subjects->subjects
    if (!v1beta1_policy_rules_with_subjects->subjects) {
        goto fail;
    }
    ...
    if (v1beta1_policy_rules_with_subjects->subjects) {
    list_ForEach(subjectsListEntry, v1beta1_policy_rules_with_subjects->subjects) {
...
v1beta1_policy_rules_with_subjects_t *v1beta1_policy_rules_with_subjects_parseFromJSON(cJSON *v1beta1_policy_rules_with_subjectsJSON){
    ...
    cJSON_ArrayForEach(non_resource_rules_local_nonprimitive,non_resource_rules )
    {
        ...
        v1beta1_non_resource_policy_rule_t *non_resource_rulesItem = v1beta1_non_resource_policy_rule_parseFromJSON(non_resource_rules_local_nonprimitive);
    ...
    cJSON_ArrayForEach(resource_rules_local_nonprimitive,resource_rules )
    {
        ...
        v1beta1_resource_policy_rule_t *resource_rulesItem = v1beta1_resource_policy_rule_parseFromJSON(resource_rules_local_nonprimitive);
    ...
    // v1beta1_policy_rules_with_subjects->subjects
    cJSON *subjects = cJSON_GetObjectItemCaseSensitive(v1beta1_policy_rules_with_subjectsJSON, "subjects");
    if (!subjects) {
        goto end;
    }
    ...
    v1beta1_policy_rules_with_subjects_local_var = v1beta1_policy_rules_with_subjects_create (
