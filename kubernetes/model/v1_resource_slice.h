...
#ifndef _v1_resource_slice_H_
#define _v1_resource_slice_H_
...
typedef struct v1_resource_slice_t v1_resource_slice_t;
...
typedef struct v1_resource_slice_t {
    char *api_version; // string
    char *kind; // string
    struct v1_object_meta_t *metadata; //model
    struct v1_resource_slice_spec_t *spec; //model
