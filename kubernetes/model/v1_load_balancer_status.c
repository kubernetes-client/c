...
static v1_load_balancer_status_t *v1_load_balancer_status_create_internal(
    list_t *ingress
    ) {
    ...
    v1_load_balancer_status_local_var->_library_owned = 1;
    return v1_load_balancer_status_local_var;
}

__attribute__((deprecated)) v1_load_balancer_status_t *v1_load_balancer_status_create(
    list_t *ingress
    ) {
    return v1_load_balancer_status_create_internal (
        ingress
        );
}
...
void v1_load_balancer_status_free(v1_load_balancer_status_t *v1_load_balancer_status) {
    ...
    if(v1_load_balancer_status->_library_owned != 1){
...
v1_load_balancer_status_t *v1_load_balancer_status_parseFromJSON(cJSON *v1_load_balancer_statusJSON){
    ...
    v1_load_balancer_status_local_var = v1_load_balancer_status_create_internal (
