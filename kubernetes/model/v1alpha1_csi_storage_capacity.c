...
#include <string.h>
#include <stdio.h>
#include "v1alpha1_csi_storage_capacity.h"



v1alpha1_csi_storage_capacity_t *v1alpha1_csi_storage_capacity_create(
    char *api_version,
    char *capacity,
    char *kind,
    ...
    v1alpha1_csi_storage_capacity_t *v1alpha1_csi_storage_capacity_local_var = malloc(sizeof(v1alpha1_csi_storage_capacity_t));
    if (!v1alpha1_csi_storage_capacity_local_var) {
        return NULL;
    }
    v1alpha1_csi_storage_capacity_local_var->api_version = api_version;
    v1alpha1_csi_storage_capacity_local_var->capacity = capacity;
    v1alpha1_csi_storage_capacity_local_var->kind = kind;
    v1alpha1_csi_storage_capacity_local_var->maximum_volume_size = maximum_volume_size;
    v1alpha1_csi_storage_capacity_local_var->metadata = metadata;
    v1alpha1_csi_storage_capacity_local_var->node_topology = node_topology;
    v1alpha1_csi_storage_capacity_local_var->storage_class_name = storage_class_name;

    return v1alpha1_csi_storage_capacity_local_var;
}


void v1alpha1_csi_storage_capacity_free(v1alpha1_csi_storage_capacity_t *v1alpha1_csi_storage_capacity) {
    if(NULL == v1alpha1_csi_storage_capacity){
        return ;
    }
    listEntry_t *listEntry;
    if (v1alpha1_csi_storage_capacity->api_version) {
        free(v1alpha1_csi_storage_capacity->api_version);
        v1alpha1_csi_storage_capacity->api_version = NULL;
    }
    if (v1alpha1_csi_storage_capacity->capacity) {
        free(v1alpha1_csi_storage_capacity->capacity);
        v1alpha1_csi_storage_capacity->capacity = NULL;
    }
    if (v1alpha1_csi_storage_capacity->kind) {
        free(v1alpha1_csi_storage_capacity->kind);
        v1alpha1_csi_storage_capacity->kind = NULL;
    }
    if (v1alpha1_csi_storage_capacity->maximum_volume_size) {
        free(v1alpha1_csi_storage_capacity->maximum_volume_size);
        v1alpha1_csi_storage_capacity->maximum_volume_size = NULL;
    }
    if (v1alpha1_csi_storage_capacity->metadata) {
        v1_object_meta_free(v1alpha1_csi_storage_capacity->metadata);
        v1alpha1_csi_storage_capacity->metadata = NULL;
    }
    if (v1alpha1_csi_storage_capacity->node_topology) {
        v1_label_selector_free(v1alpha1_csi_storage_capacity->node_topology);
        v1alpha1_csi_storage_capacity->node_topology = NULL;
    }
    if (v1alpha1_csi_storage_capacity->storage_class_name) {
        free(v1alpha1_csi_storage_capacity->storage_class_name);
        v1alpha1_csi_storage_capacity->storage_class_name = NULL;
    }
    free(v1alpha1_csi_storage_capacity);
}

cJSON *v1alpha1_csi_storage_capacity_convertToJSON(v1alpha1_csi_storage_capacity_t *v1alpha1_csi_storage_capacity) {
...
v1alpha1_csi_storage_capacity_t *v1alpha1_csi_storage_capacity_parseFromJSON(cJSON *v1alpha1_csi_storage_capacityJSON){
    ...
    // v1alpha1_csi_storage_capacity->capacity
    cJSON *capacity = cJSON_GetObjectItemCaseSensitive(v1alpha1_csi_storage_capacityJSON, "capacity");
    if (capacity) { 
    ...
    // v1alpha1_csi_storage_capacity->kind
    cJSON *kind = cJSON_GetObjectItemCaseSensitive(v1alpha1_csi_storage_capacityJSON, "kind");
    if (kind) { 
    ...
    // v1alpha1_csi_storage_capacity->maximum_volume_size
    cJSON *maximum_volume_size = cJSON_GetObjectItemCaseSensitive(v1alpha1_csi_storage_capacityJSON, "maximumVolumeSize");
    ...
    // v1alpha1_csi_storage_capacity->storage_class_name
    cJSON *storage_class_name = cJSON_GetObjectItemCaseSensitive(v1alpha1_csi_storage_capacityJSON, "storageClassName");
    ...
    v1alpha1_csi_storage_capacity_local_var = v1alpha1_csi_storage_capacity_create (
