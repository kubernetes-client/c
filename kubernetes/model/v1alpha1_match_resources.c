...
static v1alpha1_match_resources_t *v1alpha1_match_resources_create_internal(
    ...
    v1alpha1_match_resources_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1alpha1_match_resources_t *v1alpha1_match_resources_create(
    ...
    return v1alpha1_match_resources_create_internal (
...
void v1alpha1_match_resources_free(v1alpha1_match_resources_t *v1alpha1_match_resources) {
    ...
    if(v1alpha1_match_resources->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1alpha1_match_resources_free");
        return ;
    }
...
cJSON *v1alpha1_match_resources_convertToJSON(v1alpha1_match_resources_t *v1alpha1_match_resources) {
    ...
    cJSON *itemLocal = v1alpha1_named_rule_with_operations_convertToJSON(exclude_resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1alpha1_match_resources->match_policy) {
    if(cJSON_AddStringToObject(item, "matchPolicy", v1alpha1_match_resources->match_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha1_match_resources->namespace_selector) {
    cJSON *namespace_selector_local_JSON = v1_label_selector_convertToJSON(v1alpha1_match_resources->namespace_selector);
    ...
    if(v1alpha1_match_resources->object_selector) {
    cJSON *object_selector_local_JSON = v1_label_selector_convertToJSON(v1alpha1_match_resources->object_selector);
    ...
    cJSON *itemLocal = v1alpha1_named_rule_with_operations_convertToJSON(resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1alpha1_match_resources_t *v1alpha1_match_resources_parseFromJSON(cJSON *v1alpha1_match_resourcesJSON){
    ...
    v1alpha1_match_resources_local_var = v1alpha1_match_resources_create_internal (
