...
static v1_param_ref_t *v1_param_ref_create_internal(
    char *name,
    char *_namespace,
    ...
    v1_param_ref_local_var->_library_owned = 1;
    return v1_param_ref_local_var;
}

__attribute__((deprecated)) v1_param_ref_t *v1_param_ref_create(
    char *name,
    char *_namespace,
    char *parameter_not_found_action,
    v1_label_selector_t *selector
    ) {
    return v1_param_ref_create_internal (
        name,
        _namespace,
...
void v1_param_ref_free(v1_param_ref_t *v1_param_ref) {
    ...
    if(v1_param_ref->_library_owned != 1){
...
v1_param_ref_t *v1_param_ref_parseFromJSON(cJSON *v1_param_refJSON){
    ...
    v1_param_ref_local_var = v1_param_ref_create_internal (
