...
static v1_rbd_volume_source_t *v1_rbd_volume_source_create_internal(
    char *fs_type,
    char *image,
    char *keyring,
    list_t *monitors,
    ...
    v1_rbd_volume_source_local_var->_library_owned = 1;
    return v1_rbd_volume_source_local_var;
}

__attribute__((deprecated)) v1_rbd_volume_source_t *v1_rbd_volume_source_create(
    char *fs_type,
    char *image,
    char *keyring,
    list_t *monitors,
    ...
    return v1_rbd_volume_source_create_internal (
        fs_type,
        image,
        keyring,
        monitors,
...
void v1_rbd_volume_source_free(v1_rbd_volume_source_t *v1_rbd_volume_source) {
    ...
    if(v1_rbd_volume_source->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_rbd_volume_source_free");
        return ;
    }
...
v1_rbd_volume_source_t *v1_rbd_volume_source_parseFromJSON(cJSON *v1_rbd_volume_sourceJSON){
    ...
    v1_rbd_volume_source_local_var = v1_rbd_volume_source_create_internal (
