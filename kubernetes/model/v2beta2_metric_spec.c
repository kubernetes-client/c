...
v2beta2_metric_spec_t *v2beta2_metric_spec_create(
    ...
    v2beta2_metric_spec_local_var->container_resource = container_resource;
...
void v2beta2_metric_spec_free(v2beta2_metric_spec_t *v2beta2_metric_spec) {
    ...
    if (v2beta2_metric_spec->container_resource) {
        v2beta2_container_resource_metric_source_free(v2beta2_metric_spec->container_resource);
        v2beta2_metric_spec->container_resource = NULL;
    }
...
v2beta2_metric_spec_t *v2beta2_metric_spec_parseFromJSON(cJSON *v2beta2_metric_specJSON){
    ...
    if (container_resource_local_nonprim) {
        v2beta2_container_resource_metric_source_free(container_resource_local_nonprim);
