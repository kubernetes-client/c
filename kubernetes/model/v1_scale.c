...
static v1_scale_t *v1_scale_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_scale_local_var->_library_owned = 1;
    return v1_scale_local_var;
}

__attribute__((deprecated)) v1_scale_t *v1_scale_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_scale_spec_t *spec,
    ...
    return v1_scale_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
v1_scale_t *v1_scale_parseFromJSON(cJSON *v1_scaleJSON){
    ...
    v1_scale_local_var = v1_scale_create_internal (
