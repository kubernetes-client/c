...
typedef struct v1beta2_allocated_device_status_t v1beta2_allocated_device_status_t;
...
typedef struct v1beta2_allocated_device_status_t {
...
#endif /* _v1beta2_allocated_device_status_H_ */
