...
cJSON *v1_field_selector_requirement_convertToJSON(v1_field_selector_requirement_t *v1_field_selector_requirement) {
    ...
    if(cJSON_AddStringToObject(item, "key", v1_field_selector_requirement->key) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "operator", v1_field_selector_requirement->_operator) == NULL) {
    goto fail; //String
    }
