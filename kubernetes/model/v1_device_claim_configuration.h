/*
 * v1_device_claim_configuration.h
 *
 * DeviceClaimConfiguration is used for configuration parameters in DeviceClaim.
 */

#ifndef _v1_device_claim_configuration_H_
#define _v1_device_claim_configuration_H_
...
typedef struct v1_device_claim_configuration_t v1_device_claim_configuration_t;

#include "v1_opaque_device_configuration.h"



typedef struct v1_device_claim_configuration_t {
    struct v1_opaque_device_configuration_t *opaque; //model
    list_t *requests; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} v1_device_claim_configuration_t;
...
#endif /* _v1_device_claim_configuration_H_ */
