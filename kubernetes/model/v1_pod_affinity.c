...
static v1_pod_affinity_t *v1_pod_affinity_create_internal(
    ...
    v1_pod_affinity_local_var->_library_owned = 1;
    return v1_pod_affinity_local_var;
}

__attribute__((deprecated)) v1_pod_affinity_t *v1_pod_affinity_create(
    list_t *preferred_during_scheduling_ignored_during_execution,
    list_t *required_during_scheduling_ignored_during_execution
    ) {
    return v1_pod_affinity_create_internal (
...
void v1_pod_affinity_free(v1_pod_affinity_t *v1_pod_affinity) {
    ...
    if(v1_pod_affinity->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_pod_affinity_free");
        return ;
    }
...
v1_pod_affinity_t *v1_pod_affinity_parseFromJSON(cJSON *v1_pod_affinityJSON){
    ...
    v1_pod_affinity_local_var = v1_pod_affinity_create_internal (
