...
static v1_self_subject_rules_review_t *v1_self_subject_rules_review_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_self_subject_rules_review_local_var->_library_owned = 1;
    return v1_self_subject_rules_review_local_var;
}

__attribute__((deprecated)) v1_self_subject_rules_review_t *v1_self_subject_rules_review_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_self_subject_rules_review_spec_t *spec,
    ...
    return v1_self_subject_rules_review_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_self_subject_rules_review_free(v1_self_subject_rules_review_t *v1_self_subject_rules_review) {
    ...
    if(v1_self_subject_rules_review->_library_owned != 1){
...
v1_self_subject_rules_review_t *v1_self_subject_rules_review_parseFromJSON(cJSON *v1_self_subject_rules_reviewJSON){
    ...
    v1_self_subject_rules_review_local_var = v1_self_subject_rules_review_create_internal (
