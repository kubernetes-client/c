/*
 * v1beta1_limit_response.h
 *
 * LimitResponse defines how to handle requests that can not be executed right now.
 */

#ifndef _v1beta1_limit_response_H_
#define _v1beta1_limit_response_H_
...
typedef struct v1beta1_limit_response_t v1beta1_limit_response_t;

#include "v1beta1_queuing_configuration.h"



typedef struct v1beta1_limit_response_t {
    struct v1beta1_queuing_configuration_t *queuing; //model
    char *type; // string

} v1beta1_limit_response_t;
...
#endif /* _v1beta1_limit_response_H_ */
