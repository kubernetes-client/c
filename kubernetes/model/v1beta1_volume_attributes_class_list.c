...
static v1beta1_volume_attributes_class_list_t *v1beta1_volume_attributes_class_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1beta1_volume_attributes_class_list_local_var->_library_owned = 1;
    return v1beta1_volume_attributes_class_list_local_var;
}

__attribute__((deprecated)) v1beta1_volume_attributes_class_list_t *v1beta1_volume_attributes_class_list_create(
    char *api_version,
    list_t *items,
    char *kind,
    v1_list_meta_t *metadata
    ) {
    return v1beta1_volume_attributes_class_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1beta1_volume_attributes_class_list_free(v1beta1_volume_attributes_class_list_t *v1beta1_volume_attributes_class_list) {
    ...
    if(v1beta1_volume_attributes_class_list->_library_owned != 1){
...
cJSON *v1beta1_volume_attributes_class_list_convertToJSON(v1beta1_volume_attributes_class_list_t *v1beta1_volume_attributes_class_list) {
    cJSON *item = cJSON_CreateObject();

    // v1beta1_volume_attributes_class_list->api_version
    if(v1beta1_volume_attributes_class_list->api_version) {
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_volume_attributes_class_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    cJSON *itemLocal = v1beta1_volume_attributes_class_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1beta1_volume_attributes_class_list->kind) {
    if(cJSON_AddStringToObject(item, "kind", v1beta1_volume_attributes_class_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_volume_attributes_class_list->metadata) {
    cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1beta1_volume_attributes_class_list->metadata);
...
v1beta1_volume_attributes_class_list_t *v1beta1_volume_attributes_class_list_parseFromJSON(cJSON *v1beta1_volume_attributes_class_listJSON){
    ...
    // v1beta1_volume_attributes_class_list->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_class_listJSON, "apiVersion");
    ...
    // v1beta1_volume_attributes_class_list->items
    cJSON *items = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_class_listJSON, "items");
    ...
    // v1beta1_volume_attributes_class_list->kind
    cJSON *kind = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_class_listJSON, "kind");
    ...
    // v1beta1_volume_attributes_class_list->metadata
    cJSON *metadata = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_class_listJSON, "metadata");
