...
static v1beta1_validating_admission_policy_t *v1beta1_validating_admission_policy_create_internal(
    char *api_version,
    char *kind,
    ...
    v1beta1_validating_admission_policy_local_var->_library_owned = 1;
    return v1beta1_validating_admission_policy_local_var;
}

__attribute__((deprecated)) v1beta1_validating_admission_policy_t *v1beta1_validating_admission_policy_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1beta1_validating_admission_policy_spec_t *spec,
    ...
    return v1beta1_validating_admission_policy_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1beta1_validating_admission_policy_free(v1beta1_validating_admission_policy_t *v1beta1_validating_admission_policy) {
    ...
    if(v1beta1_validating_admission_policy->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_validating_admission_policy_free");
        return ;
    }
...
v1beta1_validating_admission_policy_t *v1beta1_validating_admission_policy_parseFromJSON(cJSON *v1beta1_validating_admission_policyJSON){
    ...
    v1beta1_validating_admission_policy_local_var = v1beta1_validating_admission_policy_create_internal (
