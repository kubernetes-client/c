...
#include <string.h>
#include <stdio.h>
#include "v1beta2_queuing_configuration.h"
...
v1beta2_queuing_configuration_t *v1beta2_queuing_configuration_create(
    ...
    v1beta2_queuing_configuration_t *v1beta2_queuing_configuration_local_var = malloc(sizeof(v1beta2_queuing_configuration_t));
    if (!v1beta2_queuing_configuration_local_var) {
        return NULL;
    }
    v1beta2_queuing_configuration_local_var->hand_size = hand_size;
    v1beta2_queuing_configuration_local_var->queue_length_limit = queue_length_limit;
    v1beta2_queuing_configuration_local_var->queues = queues;

    return v1beta2_queuing_configuration_local_var;
}


void v1beta2_queuing_configuration_free(v1beta2_queuing_configuration_t *v1beta2_queuing_configuration) {
    if(NULL == v1beta2_queuing_configuration){
        return ;
    }
    listEntry_t *listEntry;
    free(v1beta2_queuing_configuration);
}
...
v1beta2_queuing_configuration_t *v1beta2_queuing_configuration_parseFromJSON(cJSON *v1beta2_queuing_configurationJSON){
    ...
    v1beta2_queuing_configuration_t *v1beta2_queuing_configuration_local_var = NULL;

    // v1beta2_queuing_configuration->hand_size
    cJSON *hand_size = cJSON_GetObjectItemCaseSensitive(v1beta2_queuing_configurationJSON, "handSize");
    if (hand_size) { 
    ...
    // v1beta2_queuing_configuration->queue_length_limit
    cJSON *queue_length_limit = cJSON_GetObjectItemCaseSensitive(v1beta2_queuing_configurationJSON, "queueLengthLimit");
    ...
    // v1beta2_queuing_configuration->queues
    cJSON *queues = cJSON_GetObjectItemCaseSensitive(v1beta2_queuing_configurationJSON, "queues");
    if (queues) { 
    ...
    v1beta2_queuing_configuration_local_var = v1beta2_queuing_configuration_create (
