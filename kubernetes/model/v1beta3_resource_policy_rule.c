...
cJSON *v1beta3_resource_policy_rule_convertToJSON(v1beta3_resource_policy_rule_t *v1beta3_resource_policy_rule) {
    ...
    if(cJSON_AddBoolToObject(item, "clusterScope", v1beta3_resource_policy_rule->cluster_scope) == NULL) {
    goto fail; //Bool
    }
    }
...
v1beta3_resource_policy_rule_t *v1beta3_resource_policy_rule_parseFromJSON(cJSON *v1beta3_resource_policy_ruleJSON){
    ...
    // v1beta3_resource_policy_rule->api_groups
    cJSON *api_groups = cJSON_GetObjectItemCaseSensitive(v1beta3_resource_policy_ruleJSON, "apiGroups");
    if (!api_groups) {
        goto end;
    }
    ...
    // v1beta3_resource_policy_rule->cluster_scope
    cJSON *cluster_scope = cJSON_GetObjectItemCaseSensitive(v1beta3_resource_policy_ruleJSON, "clusterScope");
    if (cluster_scope) { 
    ...
    // v1beta3_resource_policy_rule->namespaces
    cJSON *namespaces = cJSON_GetObjectItemCaseSensitive(v1beta3_resource_policy_ruleJSON, "namespaces");
    if (namespaces) { 
    ...
    // v1beta3_resource_policy_rule->resources
    cJSON *resources = cJSON_GetObjectItemCaseSensitive(v1beta3_resource_policy_ruleJSON, "resources");
    if (!resources) {
        goto end;
    }
    ...
    // v1beta3_resource_policy_rule->verbs
    cJSON *verbs = cJSON_GetObjectItemCaseSensitive(v1beta3_resource_policy_ruleJSON, "verbs");
    if (!verbs) {
        goto end;
    }
