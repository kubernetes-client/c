/*
 * extensions_v1beta1_fs_group_strategy_options.h
 *
 * FSGroupStrategyOptions defines the strategy type and options used to create the strategy. Deprecated: use FSGroupStrategyOptions from policy API Group instead.
 */

#ifndef _extensions_v1beta1_fs_group_strategy_options_H_
#define _extensions_v1beta1_fs_group_strategy_options_H_
...
typedef struct extensions_v1beta1_fs_group_strategy_options_t extensions_v1beta1_fs_group_strategy_options_t;
...
#endif /* _extensions_v1beta1_fs_group_strategy_options_H_ */
