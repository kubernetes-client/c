/*
 * v1beta1_device_toleration.h
 *
 * The ResourceClaim this DeviceToleration is attached to tolerates any taint that matches the triple &lt;key,value,effect&gt; using the matching operator &lt;operator&gt;.
 */

#ifndef _v1beta1_device_toleration_H_
#define _v1beta1_device_toleration_H_
...
typedef struct v1beta1_device_toleration_t v1beta1_device_toleration_t;




typedef struct v1beta1_device_toleration_t {
    char *effect; // string
    char *key; // string
...
#endif /* _v1beta1_device_toleration_H_ */
