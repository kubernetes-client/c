...
#ifndef _v1beta2_device_class_H_
#define _v1beta2_device_class_H_
...
typedef struct v1beta2_device_class_t v1beta2_device_class_t;
...
typedef struct v1beta2_device_class_t {
    char *api_version; // string
    char *kind; // string
    struct v1_object_meta_t *metadata; //model
    struct v1beta2_device_class_spec_t *spec; //model
...
#endif /* _v1beta2_device_class_H_ */
