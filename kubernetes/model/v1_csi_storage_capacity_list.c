...
static v1_csi_storage_capacity_list_t *v1_csi_storage_capacity_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1_csi_storage_capacity_list_local_var->_library_owned = 1;
    return v1_csi_storage_capacity_list_local_var;
}

__attribute__((deprecated)) v1_csi_storage_capacity_list_t *v1_csi_storage_capacity_list_create(
    char *api_version,
    list_t *items,
    char *kind,
    v1_list_meta_t *metadata
    ) {
    return v1_csi_storage_capacity_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1_csi_storage_capacity_list_free(v1_csi_storage_capacity_list_t *v1_csi_storage_capacity_list) {
    ...
    if(v1_csi_storage_capacity_list->_library_owned != 1){
...
v1_csi_storage_capacity_list_t *v1_csi_storage_capacity_list_parseFromJSON(cJSON *v1_csi_storage_capacity_listJSON){
    ...
    v1_csi_storage_capacity_list_local_var = v1_csi_storage_capacity_list_create_internal (
