/*
 * v1beta2_opaque_device_configuration.h
 *
 * OpaqueDeviceConfiguration contains configuration parameters for a driver in a format defined by the driver vendor.
 */

#ifndef _v1beta2_opaque_device_configuration_H_
#define _v1beta2_opaque_device_configuration_H_
...
typedef struct v1beta2_opaque_device_configuration_t v1beta2_opaque_device_configuration_t;

#include "object.h"



typedef struct v1beta2_opaque_device_configuration_t {
    char *driver; // string
    object_t *parameters; //object

    int _library_owned; // Is the library responsible for freeing this object?
} v1beta2_opaque_device_configuration_t;
...
#endif /* _v1beta2_opaque_device_configuration_H_ */
