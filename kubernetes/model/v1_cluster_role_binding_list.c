...
static v1_cluster_role_binding_list_t *v1_cluster_role_binding_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1_cluster_role_binding_list_local_var->_library_owned = 1;
    return v1_cluster_role_binding_list_local_var;
}

__attribute__((deprecated)) v1_cluster_role_binding_list_t *v1_cluster_role_binding_list_create(
    char *api_version,
    list_t *items,
    char *kind,
    v1_list_meta_t *metadata
    ) {
    return v1_cluster_role_binding_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1_cluster_role_binding_list_free(v1_cluster_role_binding_list_t *v1_cluster_role_binding_list) {
    ...
    if(v1_cluster_role_binding_list->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_cluster_role_binding_list_free");
        return ;
    }
