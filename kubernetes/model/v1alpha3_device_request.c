...
static v1alpha3_device_request_t *v1alpha3_device_request_create_internal(
    ...
    v1alpha3_device_request_local_var->first_available = first_available;
    v1alpha3_device_request_local_var->name = name;
    v1alpha3_device_request_local_var->selectors = selectors;
    v1alpha3_device_request_local_var->tolerations = tolerations;
...
void v1alpha3_device_request_free(v1alpha3_device_request_t *v1alpha3_device_request) {
    ...
    if (v1alpha3_device_request->first_available) {
        list_ForEach(listEntry, v1alpha3_device_request->first_available) {
            v1alpha3_device_sub_request_free(listEntry->data);
        }
        list_freeList(v1alpha3_device_request->first_available);
        v1alpha3_device_request->first_available = NULL;
    }
    ...
    if (v1alpha3_device_request->tolerations) {
        list_ForEach(listEntry, v1alpha3_device_request->tolerations) {
            v1alpha3_device_toleration_free(listEntry->data);
        }
        list_freeList(v1alpha3_device_request->tolerations);
        v1alpha3_device_request->tolerations = NULL;
    }
...
cJSON *v1alpha3_device_request_convertToJSON(v1alpha3_device_request_t *v1alpha3_device_request) {
    ...
    // v1alpha3_device_request->first_available
    if(v1alpha3_device_request->first_available) {
    ...
    if (v1alpha3_device_request->first_available) {
    list_ForEach(first_availableListEntry, v1alpha3_device_request->first_available) {
    cJSON *itemLocal = v1alpha3_device_sub_request_convertToJSON(first_availableListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    // v1alpha3_device_request->tolerations
    if(v1alpha3_device_request->tolerations) {
    ...
    if (v1alpha3_device_request->tolerations) {
    list_ForEach(tolerationsListEntry, v1alpha3_device_request->tolerations) {
...
v1alpha3_device_request_t *v1alpha3_device_request_parseFromJSON(cJSON *v1alpha3_device_requestJSON){
    ...
    // define the local list for v1alpha3_device_request->first_available
    list_t *first_availableList = NULL;

    // define the local list for v1alpha3_device_request->selectors
    list_t *selectorsList = NULL;

    // define the local list for v1alpha3_device_request->tolerations
    ...
    // v1alpha3_device_request->first_available
    cJSON *first_available = cJSON_GetObjectItemCaseSensitive(v1alpha3_device_requestJSON, "firstAvailable");
    ...
    cJSON_ArrayForEach(first_available_local_nonprimitive,first_available )
    {
        ...
        v1alpha3_device_sub_request_t *first_availableItem = v1alpha3_device_sub_request_parseFromJSON(first_available_local_nonprimitive);
    ...
    // v1alpha3_device_request->tolerations
    cJSON *tolerations = cJSON_GetObjectItemCaseSensitive(v1alpha3_device_requestJSON, "tolerations");
