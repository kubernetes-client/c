...
typedef struct v2beta2_metric_spec_t v2beta2_metric_spec_t;
...
typedef struct v2beta2_metric_spec_t {
    struct v2beta2_container_resource_metric_source_t *container_resource; //model
    struct v2beta2_external_metric_source_t *external; //model
    struct v2beta2_object_metric_source_t *object; //model
    struct v2beta2_pods_metric_source_t *pods; //model
    struct v2beta2_resource_metric_source_t *resource; //model
    char *type; // string

} v2beta2_metric_spec_t;

v2beta2_metric_spec_t *v2beta2_metric_spec_create(
    v2beta2_container_resource_metric_source_t *container_resource,
