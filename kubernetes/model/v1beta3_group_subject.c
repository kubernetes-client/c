...
cJSON *v1beta3_group_subject_convertToJSON(v1beta3_group_subject_t *v1beta3_group_subject) {
    ...
    if(cJSON_AddStringToObject(item, "name", v1beta3_group_subject->name) == NULL) {
    goto fail; //String
    }
...
v1beta3_group_subject_t *v1beta3_group_subject_parseFromJSON(cJSON *v1beta3_group_subjectJSON){

    v1beta3_group_subject_t *v1beta3_group_subject_local_var = NULL;

    // v1beta3_group_subject->name
    cJSON *name = cJSON_GetObjectItemCaseSensitive(v1beta3_group_subjectJSON, "name");
    if (!name) {
        goto end;
    }
