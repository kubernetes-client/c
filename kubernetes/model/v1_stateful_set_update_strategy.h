...
// Enum TYPE for v1_stateful_set_update_strategy

typedef enum  { kubernetes_v1_stateful_set_update_strategy_TYPE_NULL = 0, kubernetes_v1_stateful_set_update_strategy_TYPE_OnDelete, kubernetes_v1_stateful_set_update_strategy_TYPE_RollingUpdate } kubernetes_v1_stateful_set_update_strategy_TYPE_e;

char* v1_stateful_set_update_strategy_type_ToString(kubernetes_v1_stateful_set_update_strategy_TYPE_e type);

kubernetes_v1_stateful_set_update_strategy_TYPE_e v1_stateful_set_update_strategy_type_FromString(char* type);



typedef struct v1_stateful_set_update_strategy_t {
    struct v1_rolling_update_stateful_set_strategy_t *rolling_update; //model
    kubernetes_v1_stateful_set_update_strategy_TYPE_e type; //enum
