/*
 * v1beta2_device_counter_consumption.h
 *
 * DeviceCounterConsumption defines a set of counters that a device will consume from a CounterSet.
 */

#ifndef _v1beta2_device_counter_consumption_H_
#define _v1beta2_device_counter_consumption_H_
...
typedef struct v1beta2_device_counter_consumption_t v1beta2_device_counter_consumption_t;

#include "v1beta2_counter.h"



typedef struct v1beta2_device_counter_consumption_t {
...
#endif /* _v1beta2_device_counter_consumption_H_ */
