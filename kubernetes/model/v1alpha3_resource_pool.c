...
static v1alpha3_resource_pool_t *v1alpha3_resource_pool_create_internal(
    long generation,
    char *name,
    ...
    v1alpha3_resource_pool_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1alpha3_resource_pool_t *v1alpha3_resource_pool_create(
    ...
    return v1alpha3_resource_pool_create_internal (
        generation,
        name,
...
void v1alpha3_resource_pool_free(v1alpha3_resource_pool_t *v1alpha3_resource_pool) {
    ...
    if(v1alpha3_resource_pool->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1alpha3_resource_pool_free");
        return ;
    }
...
v1alpha3_resource_pool_t *v1alpha3_resource_pool_parseFromJSON(cJSON *v1alpha3_resource_poolJSON){
    ...
    v1alpha3_resource_pool_local_var = v1alpha3_resource_pool_create_internal (
