...
static v1_stateful_set_condition_t *v1_stateful_set_condition_create_internal(
    ...
    v1_stateful_set_condition_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_stateful_set_condition_t *v1_stateful_set_condition_create(
    ...
    return v1_stateful_set_condition_create_internal (
...
void v1_stateful_set_condition_free(v1_stateful_set_condition_t *v1_stateful_set_condition) {
    ...
    if(v1_stateful_set_condition->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_stateful_set_condition_free");
        return ;
    }
...
v1_stateful_set_condition_t *v1_stateful_set_condition_parseFromJSON(cJSON *v1_stateful_set_conditionJSON){
    ...
    v1_stateful_set_condition_local_var = v1_stateful_set_condition_create_internal (
