...
v1beta1_resource_policy_rule_t *v1beta1_resource_policy_rule_create(
    ...
    v1beta1_resource_policy_rule_t *v1beta1_resource_policy_rule_local_var = malloc(sizeof(v1beta1_resource_policy_rule_t));
    if (!v1beta1_resource_policy_rule_local_var) {
        return NULL;
    }
    v1beta1_resource_policy_rule_local_var->api_groups = api_groups;
    v1beta1_resource_policy_rule_local_var->cluster_scope = cluster_scope;
    v1beta1_resource_policy_rule_local_var->namespaces = namespaces;
    v1beta1_resource_policy_rule_local_var->resources = resources;
    v1beta1_resource_policy_rule_local_var->verbs = verbs;
...
void v1beta1_resource_policy_rule_free(v1beta1_resource_policy_rule_t *v1beta1_resource_policy_rule) {
    if(NULL == v1beta1_resource_policy_rule){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta1_resource_policy_rule->api_groups) {
        list_ForEach(listEntry, v1beta1_resource_policy_rule->api_groups) {
            free(listEntry->data);
        }
        list_freeList(v1beta1_resource_policy_rule->api_groups);
        v1beta1_resource_policy_rule->api_groups = NULL;
    }
    if (v1beta1_resource_policy_rule->namespaces) {
        list_ForEach(listEntry, v1beta1_resource_policy_rule->namespaces) {
            free(listEntry->data);
        }
        list_freeList(v1beta1_resource_policy_rule->namespaces);
        v1beta1_resource_policy_rule->namespaces = NULL;
    }
    if (v1beta1_resource_policy_rule->resources) {
        list_ForEach(listEntry, v1beta1_resource_policy_rule->resources) {
            free(listEntry->data);
        }
        list_freeList(v1beta1_resource_policy_rule->resources);
        v1beta1_resource_policy_rule->resources = NULL;
    }
    if (v1beta1_resource_policy_rule->verbs) {
        list_ForEach(listEntry, v1beta1_resource_policy_rule->verbs) {
            free(listEntry->data);
        }
        list_freeList(v1beta1_resource_policy_rule->verbs);
        v1beta1_resource_policy_rule->verbs = NULL;
    }
    free(v1beta1_resource_policy_rule);
}
...
cJSON *v1beta1_resource_policy_rule_convertToJSON(v1beta1_resource_policy_rule_t *v1beta1_resource_policy_rule) {
    ...
    list_ForEach(api_groupsListEntry, v1beta1_resource_policy_rule->api_groups) {
    ...
    // v1beta1_resource_policy_rule->cluster_scope
    if(v1beta1_resource_policy_rule->cluster_scope) { 
    if(cJSON_AddBoolToObject(item, "clusterScope", v1beta1_resource_policy_rule->cluster_scope) == NULL) {
    goto fail; //Bool
    }
     } 
    ...
    list_ForEach(namespacesListEntry, v1beta1_resource_policy_rule->namespaces) {
    ...
    // v1beta1_resource_policy_rule->resources
    if (!v1beta1_resource_policy_rule->resources) {
        goto fail;
    }
    ...
    list_ForEach(resourcesListEntry, v1beta1_resource_policy_rule->resources) {
    ...
    // v1beta1_resource_policy_rule->verbs
    if (!v1beta1_resource_policy_rule->verbs) {
        goto fail;
    }
    ...
    list_ForEach(verbsListEntry, v1beta1_resource_policy_rule->verbs) {
...
v1beta1_resource_policy_rule_t *v1beta1_resource_policy_rule_parseFromJSON(cJSON *v1beta1_resource_policy_ruleJSON){
    ...
    // v1beta1_resource_policy_rule->cluster_scope
    cJSON *cluster_scope = cJSON_GetObjectItemCaseSensitive(v1beta1_resource_policy_ruleJSON, "clusterScope");
    if (cluster_scope) { 
    ...
    // v1beta1_resource_policy_rule->resources
    cJSON *resources = cJSON_GetObjectItemCaseSensitive(v1beta1_resource_policy_ruleJSON, "resources");
    if (!resources) {
        goto end;
    }
    ...
    // v1beta1_resource_policy_rule->verbs
    cJSON *verbs = cJSON_GetObjectItemCaseSensitive(v1beta1_resource_policy_ruleJSON, "verbs");
    if (!verbs) {
        goto end;
    }
    ...
    v1beta1_resource_policy_rule_local_var = v1beta1_resource_policy_rule_create (
        api_groupsList,
