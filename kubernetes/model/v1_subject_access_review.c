...
static v1_subject_access_review_t *v1_subject_access_review_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_subject_access_review_local_var->_library_owned = 1;
    return v1_subject_access_review_local_var;
}

__attribute__((deprecated)) v1_subject_access_review_t *v1_subject_access_review_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_subject_access_review_spec_t *spec,
    ...
    return v1_subject_access_review_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_subject_access_review_free(v1_subject_access_review_t *v1_subject_access_review) {
    ...
    if(v1_subject_access_review->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_subject_access_review_free");
        return ;
    }
...
v1_subject_access_review_t *v1_subject_access_review_parseFromJSON(cJSON *v1_subject_access_reviewJSON){
    ...
    v1_subject_access_review_local_var = v1_subject_access_review_create_internal (
