/*
 * v1_opaque_device_configuration.h
 *
 * OpaqueDeviceConfiguration contains configuration parameters for a driver in a format defined by the driver vendor.
 */

#ifndef _v1_opaque_device_configuration_H_
#define _v1_opaque_device_configuration_H_
...
typedef struct v1_opaque_device_configuration_t v1_opaque_device_configuration_t;

#include "object.h"



typedef struct v1_opaque_device_configuration_t {
    char *driver; // string
