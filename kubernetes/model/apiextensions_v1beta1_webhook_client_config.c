...
void apiextensions_v1beta1_webhook_client_config_free(apiextensions_v1beta1_webhook_client_config_t *apiextensions_v1beta1_webhook_client_config) {
    ...
    if (apiextensions_v1beta1_webhook_client_config->ca_bundle) {
        free(apiextensions_v1beta1_webhook_client_config->ca_bundle);
        apiextensions_v1beta1_webhook_client_config->ca_bundle = NULL;
    }
    if (apiextensions_v1beta1_webhook_client_config->service) {
        ...
        apiextensions_v1beta1_webhook_client_config->service = NULL;
    }
    if (apiextensions_v1beta1_webhook_client_config->url) {
        free(apiextensions_v1beta1_webhook_client_config->url);
        apiextensions_v1beta1_webhook_client_config->url = NULL;
    }
