...
static v1_limit_range_list_t *v1_limit_range_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1_limit_range_list_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_limit_range_list_t *v1_limit_range_list_create(
    ...
    return v1_limit_range_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1_limit_range_list_free(v1_limit_range_list_t *v1_limit_range_list) {
    ...
    if(v1_limit_range_list->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_limit_range_list_free");
        return ;
    }
...
v1_limit_range_list_t *v1_limit_range_list_parseFromJSON(cJSON *v1_limit_range_listJSON){
    ...
    v1_limit_range_list_local_var = v1_limit_range_list_create_internal (
