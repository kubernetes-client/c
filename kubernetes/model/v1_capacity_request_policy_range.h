/*
 * v1_capacity_request_policy_range.h
 *
...
#ifndef _v1_capacity_request_policy_range_H_
#define _v1_capacity_request_policy_range_H_
...
typedef struct v1_capacity_request_policy_range_t v1_capacity_request_policy_range_t;




typedef struct v1_capacity_request_policy_range_t {
    char *max; // string
    char *min; // string
    char *step; // string

    int _library_owned; // Is the library responsible for freeing this object?
} v1_capacity_request_policy_range_t;
...
#endif /* _v1_capacity_request_policy_range_H_ */
