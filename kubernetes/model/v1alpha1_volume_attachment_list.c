...
v1alpha1_volume_attachment_list_t *v1alpha1_volume_attachment_list_parseFromJSON(cJSON *v1alpha1_volume_attachment_listJSON){
    ...
    // define the local list for v1alpha1_volume_attachment_list->items
