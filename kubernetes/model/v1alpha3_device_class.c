...
static v1alpha3_device_class_t *v1alpha3_device_class_create_internal(
    char *api_version,
    char *kind,
    ...
    v1alpha3_device_class_local_var->_library_owned = 1;
    return v1alpha3_device_class_local_var;
}

__attribute__((deprecated)) v1alpha3_device_class_t *v1alpha3_device_class_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1alpha3_device_class_spec_t *spec
    ) {
    return v1alpha3_device_class_create_internal (
        api_version,
        kind,
        metadata,
        spec
...
void v1alpha3_device_class_free(v1alpha3_device_class_t *v1alpha3_device_class) {
    ...
    if(v1alpha3_device_class->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1alpha3_device_class_free");
        return ;
    }
...
v1alpha3_device_class_t *v1alpha3_device_class_parseFromJSON(cJSON *v1alpha3_device_classJSON){
    ...
    v1alpha3_device_class_local_var = v1alpha3_device_class_create_internal (
