...
static v1_node_selector_requirement_t *v1_node_selector_requirement_create_internal(
    char *key,
    char *_operator,
    list_t *values
    ) {
    ...
    v1_node_selector_requirement_local_var->_library_owned = 1;
    return v1_node_selector_requirement_local_var;
}

__attribute__((deprecated)) v1_node_selector_requirement_t *v1_node_selector_requirement_create(
    char *key,
    char *_operator,
    list_t *values
    ) {
    return v1_node_selector_requirement_create_internal (
        key,
        _operator,
        values
        );
...
void v1_node_selector_requirement_free(v1_node_selector_requirement_t *v1_node_selector_requirement) {
    ...
    if(v1_node_selector_requirement->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_node_selector_requirement_free");
        return ;
    }
...
v1_node_selector_requirement_t *v1_node_selector_requirement_parseFromJSON(cJSON *v1_node_selector_requirementJSON){
    ...
    v1_node_selector_requirement_local_var = v1_node_selector_requirement_create_internal (
