...
static v1beta2_device_class_spec_t *v1beta2_device_class_spec_create_internal(
    ...
    v1beta2_device_class_spec_local_var->extended_resource_name = extended_resource_name;
...
void v1beta2_device_class_spec_free(v1beta2_device_class_spec_t *v1beta2_device_class_spec) {
    ...
    if (v1beta2_device_class_spec->extended_resource_name) {
        free(v1beta2_device_class_spec->extended_resource_name);
        v1beta2_device_class_spec->extended_resource_name = NULL;
    }
...
cJSON *v1beta2_device_class_spec_convertToJSON(v1beta2_device_class_spec_t *v1beta2_device_class_spec) {
    ...
    // v1beta2_device_class_spec->extended_resource_name
    if(v1beta2_device_class_spec->extended_resource_name) {
    if(cJSON_AddStringToObject(item, "extendedResourceName", v1beta2_device_class_spec->extended_resource_name) == NULL) {
    goto fail; //String
    }
    }
...
v1beta2_device_class_spec_t *v1beta2_device_class_spec_parseFromJSON(cJSON *v1beta2_device_class_specJSON){
    ...
    // v1beta2_device_class_spec->extended_resource_name
    cJSON *extended_resource_name = cJSON_GetObjectItemCaseSensitive(v1beta2_device_class_specJSON, "extendedResourceName");
