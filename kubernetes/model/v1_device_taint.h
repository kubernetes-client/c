...
#ifndef _v1_device_taint_H_
#define _v1_device_taint_H_
...
typedef struct v1_device_taint_t v1_device_taint_t;




typedef struct v1_device_taint_t {
    char *effect; // string
    char *key; // string
