...
static v1beta1_param_kind_t *v1beta1_param_kind_create_internal(
    char *api_version,
    char *kind
    ) {
    ...
    v1beta1_param_kind_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1beta1_param_kind_t *v1beta1_param_kind_create(
    ...
    return v1beta1_param_kind_create_internal (
        api_version,
        kind
        );
}
...
void v1beta1_param_kind_free(v1beta1_param_kind_t *v1beta1_param_kind) {
    ...
    if(v1beta1_param_kind->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_param_kind_free");
        return ;
    }
...
v1beta1_param_kind_t *v1beta1_param_kind_parseFromJSON(cJSON *v1beta1_param_kindJSON){
    ...
    v1beta1_param_kind_local_var = v1beta1_param_kind_create_internal (
