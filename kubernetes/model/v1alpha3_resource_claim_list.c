...
static v1alpha3_resource_claim_list_t *v1alpha3_resource_claim_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1alpha3_resource_claim_list_local_var->_library_owned = 1;
    return v1alpha3_resource_claim_list_local_var;
}

__attribute__((deprecated)) v1alpha3_resource_claim_list_t *v1alpha3_resource_claim_list_create(
    char *api_version,
    list_t *items,
    char *kind,
    v1_list_meta_t *metadata
    ) {
    return v1alpha3_resource_claim_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1alpha3_resource_claim_list_free(v1alpha3_resource_claim_list_t *v1alpha3_resource_claim_list) {
    ...
    if(v1alpha3_resource_claim_list->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1alpha3_resource_claim_list_free");
        return ;
    }
...
v1alpha3_resource_claim_list_t *v1alpha3_resource_claim_list_parseFromJSON(cJSON *v1alpha3_resource_claim_listJSON){
    ...
    v1alpha3_resource_claim_list_local_var = v1alpha3_resource_claim_list_create_internal (
