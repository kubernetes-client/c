...
#include <string.h>
#include <stdio.h>
#include "v1beta1_flow_schema_spec.h"
...
v1beta1_flow_schema_spec_t *v1beta1_flow_schema_spec_create(
    ...
    v1beta1_flow_schema_spec_t *v1beta1_flow_schema_spec_local_var = malloc(sizeof(v1beta1_flow_schema_spec_t));
    if (!v1beta1_flow_schema_spec_local_var) {
        return NULL;
    }
    v1beta1_flow_schema_spec_local_var->distinguisher_method = distinguisher_method;
    v1beta1_flow_schema_spec_local_var->matching_precedence = matching_precedence;
    v1beta1_flow_schema_spec_local_var->priority_level_configuration = priority_level_configuration;
    v1beta1_flow_schema_spec_local_var->rules = rules;

    return v1beta1_flow_schema_spec_local_var;
}


void v1beta1_flow_schema_spec_free(v1beta1_flow_schema_spec_t *v1beta1_flow_schema_spec) {
    if(NULL == v1beta1_flow_schema_spec){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta1_flow_schema_spec->distinguisher_method) {
        v1beta1_flow_distinguisher_method_free(v1beta1_flow_schema_spec->distinguisher_method);
        v1beta1_flow_schema_spec->distinguisher_method = NULL;
    }
    if (v1beta1_flow_schema_spec->priority_level_configuration) {
        v1beta1_priority_level_configuration_reference_free(v1beta1_flow_schema_spec->priority_level_configuration);
        v1beta1_flow_schema_spec->priority_level_configuration = NULL;
    }
    if (v1beta1_flow_schema_spec->rules) {
...
cJSON *v1beta1_flow_schema_spec_convertToJSON(v1beta1_flow_schema_spec_t *v1beta1_flow_schema_spec) {
    ...
    if(v1beta1_flow_schema_spec->distinguisher_method) { 
    cJSON *distinguisher_method_local_JSON = v1beta1_flow_distinguisher_method_convertToJSON(v1beta1_flow_schema_spec->distinguisher_method);
    ...
    // v1beta1_flow_schema_spec->matching_precedence
    if(v1beta1_flow_schema_spec->matching_precedence) { 
    if(cJSON_AddNumberToObject(item, "matchingPrecedence", v1beta1_flow_schema_spec->matching_precedence) == NULL) {
    goto fail; //Numeric
    }
     } 


    // v1beta1_flow_schema_spec->priority_level_configuration
    if (!v1beta1_flow_schema_spec->priority_level_configuration) {
        goto fail;
    }
    
    cJSON *priority_level_configuration_local_JSON = v1beta1_priority_level_configuration_reference_convertToJSON(v1beta1_flow_schema_spec->priority_level_configuration);
    ...
    if (v1beta1_flow_schema_spec->rules) {
    list_ForEach(rulesListEntry, v1beta1_flow_schema_spec->rules) {
    cJSON *itemLocal = v1beta1_policy_rules_with_subjects_convertToJSON(rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1beta1_flow_schema_spec_t *v1beta1_flow_schema_spec_parseFromJSON(cJSON *v1beta1_flow_schema_specJSON){
    ...
    // v1beta1_flow_schema_spec->matching_precedence
    cJSON *matching_precedence = cJSON_GetObjectItemCaseSensitive(v1beta1_flow_schema_specJSON, "matchingPrecedence");
    ...
    // v1beta1_flow_schema_spec->priority_level_configuration
    cJSON *priority_level_configuration = cJSON_GetObjectItemCaseSensitive(v1beta1_flow_schema_specJSON, "priorityLevelConfiguration");
    ...
    cJSON_ArrayForEach(rules_local_nonprimitive,rules )
    {
        ...
        v1beta1_policy_rules_with_subjects_t *rulesItem = v1beta1_policy_rules_with_subjects_parseFromJSON(rules_local_nonprimitive);
    ...
    v1beta1_flow_schema_spec_local_var = v1beta1_flow_schema_spec_create (
    ...
    if (distinguisher_method_local_nonprim) {
        v1beta1_flow_distinguisher_method_free(distinguisher_method_local_nonprim);
