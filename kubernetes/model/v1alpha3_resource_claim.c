...
static v1alpha3_resource_claim_t *v1alpha3_resource_claim_create_internal(
    char *api_version,
    char *kind,
    ...
    v1alpha3_resource_claim_local_var->_library_owned = 1;
    return v1alpha3_resource_claim_local_var;
}

__attribute__((deprecated)) v1alpha3_resource_claim_t *v1alpha3_resource_claim_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1alpha3_resource_claim_spec_t *spec,
    ...
    return v1alpha3_resource_claim_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1alpha3_resource_claim_free(v1alpha3_resource_claim_t *v1alpha3_resource_claim) {
    ...
    if(v1alpha3_resource_claim->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1alpha3_resource_claim_free");
        return ;
    }
...
v1alpha3_resource_claim_t *v1alpha3_resource_claim_parseFromJSON(cJSON *v1alpha3_resource_claimJSON){
    ...
    v1alpha3_resource_claim_local_var = v1alpha3_resource_claim_create_internal (
