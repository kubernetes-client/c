...
static v1_type_checking_t *v1_type_checking_create_internal(
    ...
    v1_type_checking_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_type_checking_t *v1_type_checking_create(
    ...
    return v1_type_checking_create_internal (
        expression_warnings
        );
}
...
void v1_type_checking_free(v1_type_checking_t *v1_type_checking) {
    ...
    if(v1_type_checking->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_type_checking_free");
        return ;
    }
...
v1_type_checking_t *v1_type_checking_parseFromJSON(cJSON *v1_type_checkingJSON){
    ...
    v1_type_checking_local_var = v1_type_checking_create_internal (
