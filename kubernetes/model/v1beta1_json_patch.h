/*
 * v1beta1_json_patch.h
 *
 * JSONPatch defines a JSON Patch.
 */

#ifndef _v1beta1_json_patch_H_
#define _v1beta1_json_patch_H_
...
typedef struct v1beta1_json_patch_t v1beta1_json_patch_t;




typedef struct v1beta1_json_patch_t {
    char *expression; // string

    int _library_owned; // Is the library responsible for freeing this object?
} v1beta1_json_patch_t;
