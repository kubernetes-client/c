...
static v1_secret_key_selector_t *v1_secret_key_selector_create_internal(
    char *key,
    char *name,
    int optional
    ) {
    ...
    v1_secret_key_selector_local_var->_library_owned = 1;
    return v1_secret_key_selector_local_var;
}

__attribute__((deprecated)) v1_secret_key_selector_t *v1_secret_key_selector_create(
    char *key,
    char *name,
    int optional
    ) {
    return v1_secret_key_selector_create_internal (
        key,
        name,
        optional
        );
...
void v1_secret_key_selector_free(v1_secret_key_selector_t *v1_secret_key_selector) {
    ...
    if(v1_secret_key_selector->_library_owned != 1){
...
v1_secret_key_selector_t *v1_secret_key_selector_parseFromJSON(cJSON *v1_secret_key_selectorJSON){
    ...
    v1_secret_key_selector_local_var = v1_secret_key_selector_create_internal (
