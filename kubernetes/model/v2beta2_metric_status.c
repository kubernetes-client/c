...
v2beta2_metric_status_t *v2beta2_metric_status_create(
    v2beta2_container_resource_metric_status_t *container_resource,
    ...
    v2beta2_metric_status_local_var->container_resource = container_resource;
...
cJSON *v2beta2_metric_status_convertToJSON(v2beta2_metric_status_t *v2beta2_metric_status) {
    ...
    if(v2beta2_metric_status->container_resource) { 
    cJSON *container_resource_local_JSON = v2beta2_container_resource_metric_status_convertToJSON(v2beta2_metric_status->container_resource);
...
v2beta2_metric_status_t *v2beta2_metric_status_parseFromJSON(cJSON *v2beta2_metric_statusJSON){
    ...
    if (container_resource_local_nonprim) {
        v2beta2_container_resource_metric_status_free(container_resource_local_nonprim);
