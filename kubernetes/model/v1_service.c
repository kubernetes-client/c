...
static v1_service_t *v1_service_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_service_local_var->_library_owned = 1;
    return v1_service_local_var;
}

__attribute__((deprecated)) v1_service_t *v1_service_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_service_spec_t *spec,
    ...
    return v1_service_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_service_free(v1_service_t *v1_service) {
    ...
    if(v1_service->_library_owned != 1){
...
v1_service_t *v1_service_parseFromJSON(cJSON *v1_serviceJSON){
    ...
    v1_service_local_var = v1_service_create_internal (
