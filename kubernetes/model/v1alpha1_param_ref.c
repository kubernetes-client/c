...
static v1alpha1_param_ref_t *v1alpha1_param_ref_create_internal(
    char *name,
    char *_namespace,
    ...
    v1alpha1_param_ref_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1alpha1_param_ref_t *v1alpha1_param_ref_create(
    ...
    return v1alpha1_param_ref_create_internal (
        name,
        _namespace,
...
void v1alpha1_param_ref_free(v1alpha1_param_ref_t *v1alpha1_param_ref) {
    ...
    if(v1alpha1_param_ref->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1alpha1_param_ref_free");
        return ;
    }
...
v1alpha1_param_ref_t *v1alpha1_param_ref_parseFromJSON(cJSON *v1alpha1_param_refJSON){
    ...
    v1alpha1_param_ref_local_var = v1alpha1_param_ref_create_internal (
