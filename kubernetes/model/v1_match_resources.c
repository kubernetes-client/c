...
cJSON *v1_match_resources_convertToJSON(v1_match_resources_t *v1_match_resources) {
    ...
    cJSON *itemLocal = v1_named_rule_with_operations_convertToJSON(exclude_resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_match_resources->match_policy) {
    if(cJSON_AddStringToObject(item, "matchPolicy", v1_match_resources->match_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_match_resources->namespace_selector) {
    cJSON *namespace_selector_local_JSON = v1_label_selector_convertToJSON(v1_match_resources->namespace_selector);
    ...
    if(v1_match_resources->object_selector) {
    cJSON *object_selector_local_JSON = v1_label_selector_convertToJSON(v1_match_resources->object_selector);
    ...
    cJSON *itemLocal = v1_named_rule_with_operations_convertToJSON(resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
