...
static v1beta1_allocation_result_t *v1beta1_allocation_result_create_internal(
    ...
    v1beta1_allocation_result_t *v1beta1_allocation_result_local_var = malloc(sizeof(v1beta1_allocation_result_t));
    ...
    v1beta1_allocation_result_local_var->_library_owned = 1;
    return v1beta1_allocation_result_local_var;
}
...
void v1beta1_allocation_result_free(v1beta1_allocation_result_t *v1beta1_allocation_result) {
    if(NULL == v1beta1_allocation_result){
        return ;
    }
    if(v1beta1_allocation_result->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_allocation_result_free");
        return ;
    }
    ...
    if (v1beta1_allocation_result->node_selector) {
        v1_node_selector_free(v1beta1_allocation_result->node_selector);
        v1beta1_allocation_result->node_selector = NULL;
    }
    free(v1beta1_allocation_result);
}
...
cJSON *v1beta1_allocation_result_convertToJSON(v1beta1_allocation_result_t *v1beta1_allocation_result) {
    ...
    if(v1beta1_allocation_result->devices) {
    cJSON *devices_local_JSON = v1beta1_device_allocation_result_convertToJSON(v1beta1_allocation_result->devices);
    ...
    // v1beta1_allocation_result->node_selector
    if(v1beta1_allocation_result->node_selector) {
    cJSON *node_selector_local_JSON = v1_node_selector_convertToJSON(v1beta1_allocation_result->node_selector);
...
v1beta1_allocation_result_t *v1beta1_allocation_result_parseFromJSON(cJSON *v1beta1_allocation_resultJSON){
    ...
    v1beta1_allocation_result_t *v1beta1_allocation_result_local_var = NULL;

    // define the local variable for v1beta1_allocation_result->devices
    v1beta1_device_allocation_result_t *devices_local_nonprim = NULL;
    ...
    if (devices) { 
    devices_local_nonprim = v1beta1_device_allocation_result_parseFromJSON(devices); //nonprimitive
    }

    // v1beta1_allocation_result->node_selector
    cJSON *node_selector = cJSON_GetObjectItemCaseSensitive(v1beta1_allocation_resultJSON, "nodeSelector");
    ...
    if (devices_local_nonprim) {
        v1beta1_device_allocation_result_free(devices_local_nonprim);
