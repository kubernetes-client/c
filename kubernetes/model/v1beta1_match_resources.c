...
static v1beta1_match_resources_t *v1beta1_match_resources_create_internal(
    ...
    v1beta1_match_resources_local_var->_library_owned = 1;
    return v1beta1_match_resources_local_var;
}

__attribute__((deprecated)) v1beta1_match_resources_t *v1beta1_match_resources_create(
    list_t *exclude_resource_rules,
    char *match_policy,
    v1_label_selector_t *namespace_selector,
    v1_label_selector_t *object_selector,
    ...
    return v1beta1_match_resources_create_internal (
...
void v1beta1_match_resources_free(v1beta1_match_resources_t *v1beta1_match_resources) {
    ...
    if(v1beta1_match_resources->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_match_resources_free");
        return ;
    }
...
v1beta1_match_resources_t *v1beta1_match_resources_parseFromJSON(cJSON *v1beta1_match_resourcesJSON){
    ...
    v1beta1_match_resources_local_var = v1beta1_match_resources_create_internal (
