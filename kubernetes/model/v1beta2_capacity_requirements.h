/*
 * v1beta2_capacity_requirements.h
 *
 * CapacityRequirements defines the capacity requirements for a specific device request.
 */

#ifndef _v1beta2_capacity_requirements_H_
#define _v1beta2_capacity_requirements_H_
...
typedef struct v1beta2_capacity_requirements_t v1beta2_capacity_requirements_t;




typedef struct v1beta2_capacity_requirements_t {
    list_t* requests; //map

    int _library_owned; // Is the library responsible for freeing this object?
} v1beta2_capacity_requirements_t;
...
#endif /* _v1beta2_capacity_requirements_H_ */
