...
static v1_replication_controller_condition_t *v1_replication_controller_condition_create_internal(
    ...
    v1_replication_controller_condition_local_var->_library_owned = 1;
    return v1_replication_controller_condition_local_var;
}

__attribute__((deprecated)) v1_replication_controller_condition_t *v1_replication_controller_condition_create(
    char *last_transition_time,
    char *message,
    char *reason,
    char *status,
    ...
    return v1_replication_controller_condition_create_internal (
...
void v1_replication_controller_condition_free(v1_replication_controller_condition_t *v1_replication_controller_condition) {
    ...
    if(v1_replication_controller_condition->_library_owned != 1){
...
v1_replication_controller_condition_t *v1_replication_controller_condition_parseFromJSON(cJSON *v1_replication_controller_conditionJSON){
    ...
    v1_replication_controller_condition_local_var = v1_replication_controller_condition_create_internal (
