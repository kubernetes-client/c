...
static v1_api_service_list_t *v1_api_service_list_create_internal(
    char *api_version,
    list_t *items,
    char *kind,
    ...
    v1_api_service_list_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_api_service_list_t *v1_api_service_list_create(
    ...
    return v1_api_service_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1_api_service_list_free(v1_api_service_list_t *v1_api_service_list) {
    ...
    if(v1_api_service_list->_library_owned != 1){
...
v1_api_service_list_t *v1_api_service_list_parseFromJSON(cJSON *v1_api_service_listJSON){
    ...
    v1_api_service_list_local_var = v1_api_service_list_create_internal (
