...
#ifndef _v1_allocated_device_status_H_
#define _v1_allocated_device_status_H_
...
typedef struct v1_allocated_device_status_t v1_allocated_device_status_t;
...
typedef struct v1_allocated_device_status_t {
    list_t *conditions; //nonprimitive container
    object_t *data; //object
    char *device; // string
    char *driver; // string
    struct v1_network_device_data_t *network_data; //model
    char *pool; // string
    char *share_id; // string

    int _library_owned; // Is the library responsible for freeing this object?
} v1_allocated_device_status_t;
...
#endif /* _v1_allocated_device_status_H_ */
