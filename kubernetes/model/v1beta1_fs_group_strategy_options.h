/*
 * v1beta1_fs_group_strategy_options.h
 *
 * FSGroupStrategyOptions defines the strategy type and options used to create the strategy.
 */

#ifndef _v1beta1_fs_group_strategy_options_H_
#define _v1beta1_fs_group_strategy_options_H_
...
typedef struct v1beta1_fs_group_strategy_options_t v1beta1_fs_group_strategy_options_t;

#include "v1beta1_id_range.h"



typedef struct v1beta1_fs_group_strategy_options_t {
    list_t *ranges; //nonprimitive container
    char *rule; // string

} v1beta1_fs_group_strategy_options_t;
...
#endif /* _v1beta1_fs_group_strategy_options_H_ */
