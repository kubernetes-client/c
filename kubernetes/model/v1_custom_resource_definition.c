...
static v1_custom_resource_definition_t *v1_custom_resource_definition_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_custom_resource_definition_local_var->_library_owned = 1;
    return v1_custom_resource_definition_local_var;
}

__attribute__((deprecated)) v1_custom_resource_definition_t *v1_custom_resource_definition_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_custom_resource_definition_spec_t *spec,
    ...
    return v1_custom_resource_definition_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_custom_resource_definition_free(v1_custom_resource_definition_t *v1_custom_resource_definition) {
    ...
    if(v1_custom_resource_definition->_library_owned != 1){
...
v1_custom_resource_definition_t *v1_custom_resource_definition_parseFromJSON(cJSON *v1_custom_resource_definitionJSON){
    ...
    v1_custom_resource_definition_local_var = v1_custom_resource_definition_create_internal (
