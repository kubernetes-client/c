...
static v1beta1_device_class_spec_t *v1beta1_device_class_spec_create_internal(
    ...
    return v1beta1_device_class_spec_local_var;
}
...
void v1beta1_device_class_spec_free(v1beta1_device_class_spec_t *v1beta1_device_class_spec) {
    if(NULL == v1beta1_device_class_spec){
        return ;
    }
    if(v1beta1_device_class_spec->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_device_class_spec_free");
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta1_device_class_spec->config) {
        list_ForEach(listEntry, v1beta1_device_class_spec->config) {
            v1beta1_device_class_configuration_free(listEntry->data);
        }
    ...
    if (v1beta1_device_class_spec->selectors) {
        ...
        list_freeList(v1beta1_device_class_spec->selectors);
        v1beta1_device_class_spec->selectors = NULL;
    }
    free(v1beta1_device_class_spec);
}

cJSON *v1beta1_device_class_spec_convertToJSON(v1beta1_device_class_spec_t *v1beta1_device_class_spec) {
    cJSON *item = cJSON_CreateObject();

    // v1beta1_device_class_spec->config
    if(v1beta1_device_class_spec->config) {
    ...
    if (v1beta1_device_class_spec->config) {
    list_ForEach(configListEntry, v1beta1_device_class_spec->config) {
    cJSON *itemLocal = v1beta1_device_class_configuration_convertToJSON(configListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if (v1beta1_device_class_spec->selectors) {
    list_ForEach(selectorsListEntry, v1beta1_device_class_spec->selectors) {
...
v1beta1_device_class_spec_t *v1beta1_device_class_spec_parseFromJSON(cJSON *v1beta1_device_class_specJSON){

    v1beta1_device_class_spec_t *v1beta1_device_class_spec_local_var = NULL;

    // define the local list for v1beta1_device_class_spec->config
    list_t *configList = NULL;

    // define the local list for v1beta1_device_class_spec->selectors
    list_t *selectorsList = NULL;

    // v1beta1_device_class_spec->config
    cJSON *config = cJSON_GetObjectItemCaseSensitive(v1beta1_device_class_specJSON, "config");
    ...
    cJSON_ArrayForEach(config_local_nonprimitive,config )
    {
        ...
        v1beta1_device_class_configuration_t *configItem = v1beta1_device_class_configuration_parseFromJSON(config_local_nonprimitive);
