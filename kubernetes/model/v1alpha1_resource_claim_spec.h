/*
 * v1alpha1_resource_claim_spec.h
 *
 * ResourceClaimSpec defines how a resource is to be allocated.
 */

#ifndef _v1alpha1_resource_claim_spec_H_
...
typedef struct v1alpha1_resource_claim_spec_t v1alpha1_resource_claim_spec_t;

#include "v1alpha1_resource_claim_parameters_reference.h"



typedef struct v1alpha1_resource_claim_spec_t {
    char *allocation_mode; // string
    struct v1alpha1_resource_claim_parameters_reference_t *parameters_ref; //model
...
#endif /* _v1alpha1_resource_claim_spec_H_ */
