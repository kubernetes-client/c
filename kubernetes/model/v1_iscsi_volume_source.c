...
static v1_iscsi_volume_source_t *v1_iscsi_volume_source_create_internal(
    ...
    v1_iscsi_volume_source_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_iscsi_volume_source_t *v1_iscsi_volume_source_create(
    ...
    return v1_iscsi_volume_source_create_internal (
        chap_auth_discovery,
        chap_auth_session,
        fs_type,
        initiator_name,
...
void v1_iscsi_volume_source_free(v1_iscsi_volume_source_t *v1_iscsi_volume_source) {
    ...
    if(v1_iscsi_volume_source->_library_owned != 1){
...
v1_iscsi_volume_source_t *v1_iscsi_volume_source_parseFromJSON(cJSON *v1_iscsi_volume_sourceJSON){
    ...
    v1_iscsi_volume_source_local_var = v1_iscsi_volume_source_create_internal (
