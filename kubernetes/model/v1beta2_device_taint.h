/*
 * v1beta2_device_taint.h
 *
 * The device this taint is attached to has the \&quot;effect\&quot; on any claim which does not tolerate the taint and, through the claim, to pods using the claim.
 */

#ifndef _v1beta2_device_taint_H_
#define _v1beta2_device_taint_H_
...
typedef struct v1beta2_device_taint_t v1beta2_device_taint_t;




typedef struct v1beta2_device_taint_t {
    char *effect; // string
    char *key; // string
...
#endif /* _v1beta2_device_taint_H_ */
