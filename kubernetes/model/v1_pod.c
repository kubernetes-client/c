...
static v1_pod_t *v1_pod_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_pod_local_var->_library_owned = 1;
...
v1_pod_t *v1_pod_parseFromJSON(cJSON *v1_podJSON){
    ...
    v1_pod_local_var = v1_pod_create_internal (
