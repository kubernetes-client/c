...
static v1_token_review_t *v1_token_review_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_token_review_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_token_review_t *v1_token_review_create(
    ...
    return v1_token_review_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_token_review_free(v1_token_review_t *v1_token_review) {
    ...
    if(v1_token_review->_library_owned != 1){
...
v1_token_review_t *v1_token_review_parseFromJSON(cJSON *v1_token_reviewJSON){
    ...
    v1_token_review_local_var = v1_token_review_create_internal (
