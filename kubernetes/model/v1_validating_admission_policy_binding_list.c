...
static v1_validating_admission_policy_binding_list_t *v1_validating_admission_policy_binding_list_create_internal(
    ...
    v1_validating_admission_policy_binding_list_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_validating_admission_policy_binding_list_t *v1_validating_admission_policy_binding_list_create(
    ...
    return v1_validating_admission_policy_binding_list_create_internal (
        api_version,
        items,
        kind,
        metadata
...
void v1_validating_admission_policy_binding_list_free(v1_validating_admission_policy_binding_list_t *v1_validating_admission_policy_binding_list) {
    ...
    if(v1_validating_admission_policy_binding_list->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_validating_admission_policy_binding_list_free");
        return ;
    }
...
v1_validating_admission_policy_binding_list_t *v1_validating_admission_policy_binding_list_parseFromJSON(cJSON *v1_validating_admission_policy_binding_listJSON){
    ...
    v1_validating_admission_policy_binding_list_local_var = v1_validating_admission_policy_binding_list_create_internal (
