...
static v1beta1_volume_attributes_class_t *v1beta1_volume_attributes_class_create_internal(
    char *api_version,
    char *driver_name,
    char *kind,
    ...
    v1beta1_volume_attributes_class_local_var->_library_owned = 1;
    return v1beta1_volume_attributes_class_local_var;
}

__attribute__((deprecated)) v1beta1_volume_attributes_class_t *v1beta1_volume_attributes_class_create(
    char *api_version,
    char *driver_name,
    char *kind,
    v1_object_meta_t *metadata,
    ...
    return v1beta1_volume_attributes_class_create_internal (
        api_version,
        driver_name,
        kind,
        metadata,
...
void v1beta1_volume_attributes_class_free(v1beta1_volume_attributes_class_t *v1beta1_volume_attributes_class) {
    ...
    if(v1beta1_volume_attributes_class->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1beta1_volume_attributes_class_free");
        return ;
    }
