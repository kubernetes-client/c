...
static v1beta1_validating_admission_policy_status_t *v1beta1_validating_admission_policy_status_create_internal(
    list_t *conditions,
    ...
    v1beta1_validating_admission_policy_status_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1beta1_validating_admission_policy_status_t *v1beta1_validating_admission_policy_status_create(
    ...
    return v1beta1_validating_admission_policy_status_create_internal (
        conditions,
        observed_generation,
        type_checking
        );
...
void v1beta1_validating_admission_policy_status_free(v1beta1_validating_admission_policy_status_t *v1beta1_validating_admission_policy_status) {
    ...
    if(v1beta1_validating_admission_policy_status->_library_owned != 1){
