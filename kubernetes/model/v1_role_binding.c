...
static v1_role_binding_t *v1_role_binding_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_role_binding_local_var->_library_owned = 1;
    return v1_role_binding_local_var;
}

__attribute__((deprecated)) v1_role_binding_t *v1_role_binding_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_role_ref_t *role_ref,
    ...
    return v1_role_binding_create_internal (
        api_version,
        kind,
        metadata,
        role_ref,
...
void v1_role_binding_free(v1_role_binding_t *v1_role_binding) {
    ...
    if(v1_role_binding->_library_owned != 1){
...
v1_role_binding_t *v1_role_binding_parseFromJSON(cJSON *v1_role_bindingJSON){
    ...
    v1_role_binding_local_var = v1_role_binding_create_internal (
