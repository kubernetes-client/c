...
static v1alpha3_resource_slice_spec_t *v1alpha3_resource_slice_spec_create_internal(
    ...
    v1alpha3_resource_slice_spec_local_var->per_device_node_selection = per_device_node_selection;
    v1alpha3_resource_slice_spec_local_var->pool = pool;
    v1alpha3_resource_slice_spec_local_var->shared_counters = shared_counters;
...
void v1alpha3_resource_slice_spec_free(v1alpha3_resource_slice_spec_t *v1alpha3_resource_slice_spec) {
    ...
    if (v1alpha3_resource_slice_spec->shared_counters) {
        list_ForEach(listEntry, v1alpha3_resource_slice_spec->shared_counters) {
            v1alpha3_counter_set_free(listEntry->data);
        }
        list_freeList(v1alpha3_resource_slice_spec->shared_counters);
        v1alpha3_resource_slice_spec->shared_counters = NULL;
    }
...
cJSON *v1alpha3_resource_slice_spec_convertToJSON(v1alpha3_resource_slice_spec_t *v1alpha3_resource_slice_spec) {
    ...
    // v1alpha3_resource_slice_spec->per_device_node_selection
    if(v1alpha3_resource_slice_spec->per_device_node_selection) {
    if(cJSON_AddBoolToObject(item, "perDeviceNodeSelection", v1alpha3_resource_slice_spec->per_device_node_selection) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // v1alpha3_resource_slice_spec->shared_counters
    if(v1alpha3_resource_slice_spec->shared_counters) {
    ...
    if (v1alpha3_resource_slice_spec->shared_counters) {
    list_ForEach(shared_countersListEntry, v1alpha3_resource_slice_spec->shared_counters) {
    cJSON *itemLocal = v1alpha3_counter_set_convertToJSON(shared_countersListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1alpha3_resource_slice_spec_t *v1alpha3_resource_slice_spec_parseFromJSON(cJSON *v1alpha3_resource_slice_specJSON){
    ...
    // define the local list for v1alpha3_resource_slice_spec->shared_counters
    ...
    // v1alpha3_resource_slice_spec->per_device_node_selection
    cJSON *per_device_node_selection = cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_slice_specJSON, "perDeviceNodeSelection");
    ...
    // v1alpha3_resource_slice_spec->shared_counters
    cJSON *shared_counters = cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_slice_specJSON, "sharedCounters");
    ...
    cJSON_ArrayForEach(shared_counters_local_nonprimitive,shared_counters )
    {
        ...
        v1alpha3_counter_set_t *shared_countersItem = v1alpha3_counter_set_parseFromJSON(shared_counters_local_nonprimitive);
