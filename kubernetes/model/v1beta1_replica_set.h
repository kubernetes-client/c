...
typedef struct v1beta1_replica_set_t v1beta1_replica_set_t;
...
typedef struct v1beta1_replica_set_t {
    ...
    struct v1beta1_replica_set_spec_t *spec; //model
    struct v1beta1_replica_set_status_t *status; //model
