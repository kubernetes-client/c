...
v1beta1_limited_priority_level_configuration_t *v1beta1_limited_priority_level_configuration_create(
    ...
    v1beta1_limited_priority_level_configuration_t *v1beta1_limited_priority_level_configuration_local_var = malloc(sizeof(v1beta1_limited_priority_level_configuration_t));
    if (!v1beta1_limited_priority_level_configuration_local_var) {
        return NULL;
    }
    v1beta1_limited_priority_level_configuration_local_var->assured_concurrency_shares = assured_concurrency_shares;
    v1beta1_limited_priority_level_configuration_local_var->limit_response = limit_response;

    return v1beta1_limited_priority_level_configuration_local_var;
}
...
void v1beta1_limited_priority_level_configuration_free(v1beta1_limited_priority_level_configuration_t *v1beta1_limited_priority_level_configuration) {
    if(NULL == v1beta1_limited_priority_level_configuration){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta1_limited_priority_level_configuration->limit_response) {
        v1beta1_limit_response_free(v1beta1_limited_priority_level_configuration->limit_response);
        v1beta1_limited_priority_level_configuration->limit_response = NULL;
    }
    free(v1beta1_limited_priority_level_configuration);
}
...
v1beta1_limited_priority_level_configuration_t *v1beta1_limited_priority_level_configuration_parseFromJSON(cJSON *v1beta1_limited_priority_level_configurationJSON){
    ...
    v1beta1_limited_priority_level_configuration_local_var = v1beta1_limited_priority_level_configuration_create (
    ...
    if (limit_response_local_nonprim) {
        v1beta1_limit_response_free(limit_response_local_nonprim);
