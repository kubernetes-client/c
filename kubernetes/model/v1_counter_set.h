...
#ifndef _v1_counter_set_H_
#define _v1_counter_set_H_
...
typedef struct v1_counter_set_t v1_counter_set_t;

#include "v1_counter.h"



typedef struct v1_counter_set_t {
    list_t* counters; //map
    char *name; // string
