...
#include <string.h>
#include <stdio.h>
#include "v1beta2_non_resource_policy_rule.h"
...
v1beta2_non_resource_policy_rule_t *v1beta2_non_resource_policy_rule_create(
    ...
    v1beta2_non_resource_policy_rule_t *v1beta2_non_resource_policy_rule_local_var = malloc(sizeof(v1beta2_non_resource_policy_rule_t));
    if (!v1beta2_non_resource_policy_rule_local_var) {
        return NULL;
    }
    v1beta2_non_resource_policy_rule_local_var->non_resource_urls = non_resource_urls;
    v1beta2_non_resource_policy_rule_local_var->verbs = verbs;

    return v1beta2_non_resource_policy_rule_local_var;
}


void v1beta2_non_resource_policy_rule_free(v1beta2_non_resource_policy_rule_t *v1beta2_non_resource_policy_rule) {
    if(NULL == v1beta2_non_resource_policy_rule){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta2_non_resource_policy_rule->non_resource_urls) {
        list_ForEach(listEntry, v1beta2_non_resource_policy_rule->non_resource_urls) {
            free(listEntry->data);
        }
        list_freeList(v1beta2_non_resource_policy_rule->non_resource_urls);
        v1beta2_non_resource_policy_rule->non_resource_urls = NULL;
    }
    if (v1beta2_non_resource_policy_rule->verbs) {
        list_ForEach(listEntry, v1beta2_non_resource_policy_rule->verbs) {
            free(listEntry->data);
        }
        list_freeList(v1beta2_non_resource_policy_rule->verbs);
        v1beta2_non_resource_policy_rule->verbs = NULL;
    }
    free(v1beta2_non_resource_policy_rule);
}
...
cJSON *v1beta2_non_resource_policy_rule_convertToJSON(v1beta2_non_resource_policy_rule_t *v1beta2_non_resource_policy_rule) {
    ...
    // v1beta2_non_resource_policy_rule->non_resource_urls
    if (!v1beta2_non_resource_policy_rule->non_resource_urls) {
        goto fail;
    }
    ...
    list_ForEach(non_resource_urlsListEntry, v1beta2_non_resource_policy_rule->non_resource_urls) {
    ...
    // v1beta2_non_resource_policy_rule->verbs
    if (!v1beta2_non_resource_policy_rule->verbs) {
        goto fail;
    }
    ...
    list_ForEach(verbsListEntry, v1beta2_non_resource_policy_rule->verbs) {
...
v1beta2_non_resource_policy_rule_t *v1beta2_non_resource_policy_rule_parseFromJSON(cJSON *v1beta2_non_resource_policy_ruleJSON){
    ...
    v1beta2_non_resource_policy_rule_t *v1beta2_non_resource_policy_rule_local_var = NULL;

    // define the local list for v1beta2_non_resource_policy_rule->non_resource_urls
    list_t *non_resource_urlsList = NULL;

    // define the local list for v1beta2_non_resource_policy_rule->verbs
    list_t *verbsList = NULL;

    // v1beta2_non_resource_policy_rule->non_resource_urls
    cJSON *non_resource_urls = cJSON_GetObjectItemCaseSensitive(v1beta2_non_resource_policy_ruleJSON, "nonResourceURLs");
    ...
    // v1beta2_non_resource_policy_rule->verbs
    cJSON *verbs = cJSON_GetObjectItemCaseSensitive(v1beta2_non_resource_policy_ruleJSON, "verbs");
    if (!verbs) {
        goto end;
    }
    ...
    v1beta2_non_resource_policy_rule_local_var = v1beta2_non_resource_policy_rule_create (
