/*
 * v1_cel_device_selector.h
 *
 * CELDeviceSelector contains a CEL expression for selecting a device.
 */

#ifndef _v1_cel_device_selector_H_
#define _v1_cel_device_selector_H_
...
typedef struct v1_cel_device_selector_t v1_cel_device_selector_t;




typedef struct v1_cel_device_selector_t {
    char *expression; // string

    int _library_owned; // Is the library responsible for freeing this object?
} v1_cel_device_selector_t;
...
#endif /* _v1_cel_device_selector_H_ */
