...
static v1_persistent_volume_t *v1_persistent_volume_create_internal(
    char *api_version,
    char *kind,
    ...
    v1_persistent_volume_local_var->_library_owned = 1;
    return v1_persistent_volume_local_var;
}

__attribute__((deprecated)) v1_persistent_volume_t *v1_persistent_volume_create(
    char *api_version,
    char *kind,
    v1_object_meta_t *metadata,
    v1_persistent_volume_spec_t *spec,
    ...
    return v1_persistent_volume_create_internal (
        api_version,
        kind,
        metadata,
        spec,
...
void v1_persistent_volume_free(v1_persistent_volume_t *v1_persistent_volume) {
    ...
    if(v1_persistent_volume->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "v1_persistent_volume_free");
        return ;
    }
...
v1_persistent_volume_t *v1_persistent_volume_parseFromJSON(cJSON *v1_persistent_volumeJSON){
    ...
    v1_persistent_volume_local_var = v1_persistent_volume_create_internal (
