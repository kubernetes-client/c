...
cJSON *v1alpha1_self_subject_review_convertToJSON(v1alpha1_self_subject_review_t *v1alpha1_self_subject_review) {
    ...
    if(v1alpha1_self_subject_review->api_version) {
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_self_subject_review->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha1_self_subject_review->kind) {
    if(cJSON_AddStringToObject(item, "kind", v1alpha1_self_subject_review->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha1_self_subject_review->metadata) {
    cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1alpha1_self_subject_review->metadata);
    ...
    if(v1alpha1_self_subject_review->status) {
    cJSON *status_local_JSON = v1alpha1_self_subject_review_status_convertToJSON(v1alpha1_self_subject_review->status);
...
v1alpha1_self_subject_review_t *v1alpha1_self_subject_review_parseFromJSON(cJSON *v1alpha1_self_subject_reviewJSON){
    ...
    // v1alpha1_self_subject_review->api_version
    cJSON *api_version = cJSON_GetObjectItemCaseSensitive(v1alpha1_self_subject_reviewJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1alpha1_self_subject_review->kind
    cJSON *kind = cJSON_GetObjectItemCaseSensitive(v1alpha1_self_subject_reviewJSON, "kind");
    if (kind) { 
    ...
    // v1alpha1_self_subject_review->metadata
    cJSON *metadata = cJSON_GetObjectItemCaseSensitive(v1alpha1_self_subject_reviewJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1alpha1_self_subject_review->status
    cJSON *status = cJSON_GetObjectItemCaseSensitive(v1alpha1_self_subject_reviewJSON, "status");
    if (status) { 
