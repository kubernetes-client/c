...
static v1_ephemeral_container_t *v1_ephemeral_container_create_internal(
    list_t *args,
    list_t *command,
    list_t *env,
    list_t *env_from,
    ...
    v1_ephemeral_container_local_var->_library_owned = 1;
...
__attribute__((deprecated)) v1_ephemeral_container_t *v1_ephemeral_container_create(
    ...
    return v1_ephemeral_container_create_internal (
        args,
        command,
        env,
        env_from,
...
void v1_ephemeral_container_free(v1_ephemeral_container_t *v1_ephemeral_container) {
    ...
    if(v1_ephemeral_container->_library_owned != 1){
...
v1_ephemeral_container_t *v1_ephemeral_container_parseFromJSON(cJSON *v1_ephemeral_containerJSON){
    ...
    if (cJSON_IsNull(target_container_name)) {
    ...
    v1_ephemeral_container_local_var = v1_ephemeral_container_create_internal (
        args ? argsList : NULL,
