...
**conditions** | [**list_t**](v1_replication_controller_condition.md) \* | Represents the latest available observations of a replication controller&#39;s current state. | [optional] 
