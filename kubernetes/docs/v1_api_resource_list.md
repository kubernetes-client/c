...
**group_version** | **char \*** | groupVersion is the group and version this APIResourceList is for. | 
...
**resources** | [**list_t**](v1_api_resource.md) \* | resources contains the name of the resources and if they are namespaced. | 
