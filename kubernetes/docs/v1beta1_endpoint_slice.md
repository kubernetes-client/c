...
**endpoints** | [**list_t**](v1beta1_endpoint.md) \* | endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints. | 
