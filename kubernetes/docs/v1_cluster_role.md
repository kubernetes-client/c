...
------------ | ------------- | ------------- | -------------
**aggregation_rule** | [**v1_aggregation_rule_t**](v1_aggregation_rule.md) \* |  | [optional] 
...
**rules** | [**list_t**](v1_policy_rule.md) \* | Rules holds all the PolicyRules for this ClusterRole | [optional] 
