...
**role_ref** | [**v1beta1_role_ref_t**](v1beta1_role_ref.md) \* |  | 
**subjects** | [**list_t**](v1beta1_subject.md) \* | Subjects holds references to the objects the role applies to. | [optional] 
