...
//
v1_runtime_class_t* NodeV1API_createRuntimeClass(apiClient_t *apiClient, v1_runtime_class_t * body, char * pretty, char * dryRun, char * fieldManager);
```
...
//
v1_runtime_class_t* NodeV1API_patchRuntimeClass(apiClient_t *apiClient, char * name, object_t * body, char * pretty, char * dryRun, char * fieldManager, int force);
```
...
//
v1_runtime_class_t* NodeV1API_replaceRuntimeClass(apiClient_t *apiClient, char * name, v1_runtime_class_t * body, char * pretty, char * dryRun, char * fieldManager);
```
