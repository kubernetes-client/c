...
**last_scale_time** | **char \*** | last time the HorizontalPodAutoscaler scaled the number of pods; used by the autoscaler to control how often the number of pods is changed. | [optional] 
**observed_generation** | **long** | most recent generation observed by this autoscaler. | [optional] 
