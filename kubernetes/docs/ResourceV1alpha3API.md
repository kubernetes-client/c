...
[**ResourceV1alpha3API_getAPIResources_27**](ResourceV1alpha3API.md#ResourceV1alpha3API_getAPIResources_27) | **GET** /apis/resource.k8s.io/v1alpha3/ | 
...
# **ResourceV1alpha3API_getAPIResources_27**
```c
// get available resources
//
v1_api_resource_list_t* ResourceV1alpha3API_getAPIResources_27(apiClient_t *apiClient);
```
