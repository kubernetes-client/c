...
**role_ref** | [**v1alpha1_role_ref_t**](v1alpha1_role_ref.md) \* |  | 
**subjects** | [**list_t**](rbac_v1alpha1_subject.md) \* | Subjects holds references to the objects the role applies to. | [optional] 
