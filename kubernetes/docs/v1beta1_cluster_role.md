...
------------ | ------------- | ------------- | -------------
**aggregation_rule** | [**v1beta1_aggregation_rule_t**](v1beta1_aggregation_rule.md) \* |  | [optional] 
...
**rules** | [**list_t**](v1beta1_policy_rule.md) \* | Rules holds all the PolicyRules for this ClusterRole | [optional] 
