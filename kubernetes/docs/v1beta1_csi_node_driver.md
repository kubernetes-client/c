...
------------ | ------------- | ------------- | -------------
**allocatable** | [**v1beta1_volume_node_resources_t**](v1beta1_volume_node_resources.md) \* |  | [optional] 
**name** | **char \*** | This is the name of the CSI driver that this object refers to. This MUST be the same name returned by the CSI GetPluginName() call for that driver. | 
