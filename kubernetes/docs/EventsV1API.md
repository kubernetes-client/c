...
// create an Event
//
events_v1_event_t* EventsV1API_createNamespacedEvent(apiClient_t *apiClient, char * _namespace, events_v1_event_t * body, char * pretty, char * dryRun, char * fieldManager);
```
...
**body** | **[events_v1_event_t](events_v1_event.md) \*** |  | 
...
[events_v1_event_t](events_v1_event.md) *
...
//
events_v1_event_list_t* EventsV1API_listEventForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks, char * _continue, char * fieldSelector, char * labelSelector, int limit, char * pretty, char * resourceVersion, char * resourceVersionMatch, int timeoutSeconds, int watch);
```
...
[events_v1_event_list_t](events_v1_event_list.md) *
...
// list or watch objects of kind Event
//
events_v1_event_list_t* EventsV1API_listNamespacedEvent(apiClient_t *apiClient, char * _namespace, char * pretty, int allowWatchBookmarks, char * _continue, char * fieldSelector, char * labelSelector, int limit, char * resourceVersion, char * resourceVersionMatch, int timeoutSeconds, int watch);
```
...
//
events_v1_event_t* EventsV1API_patchNamespacedEvent(apiClient_t *apiClient, char * name, char * _namespace, object_t * body, char * pretty, char * dryRun, char * fieldManager, int force);
```
...
//
events_v1_event_t* EventsV1API_replaceNamespacedEvent(apiClient_t *apiClient, char * name, char * _namespace, events_v1_event_t * body, char * pretty, char * dryRun, char * fieldManager);
```
